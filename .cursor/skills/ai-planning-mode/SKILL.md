...
description: create an implementation plan before editing code. use when a technical task, tr, or tr-update is about to be implemented. reads spec, hu, tr, rules, and existing code context, then outputs impact by layer, risks, task order, tests, blockers, and confirms no scope change before code changes.
---

# Modo Planificacion IA
