...
3. **Si se personaliza** toolbar, menú o plantilla, **reintegrar** explícitamente los items nativos que la HU/TR o `.cursor/rules/multi/08-devextreme-grid-standards.md` ó `.cursor/rules/mono/08-devextreme-grid-standards.md` exigen (búsqueda, export, etc.).
