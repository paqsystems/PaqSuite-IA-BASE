...
- Ruta: `docs/04-tareas/` manteniendo la estructura relativa de la HU (reemplazando `03-historias-usuario` por `04-tareas`).
  Ejemplo: HU en `docs/03-historias-usuario/001-Seguridad/HU-010-xxx.md` → TR en `docs/04-tareas/001-Seguridad/TR-010-xxx.md`.
  HU en `docs/03-historias-usuario/updates/001-Seguridad/HU-010-xxx-update.md` → TR en `docs/04-tareas/updates/001-Seguridad/TR-010-xxx-update.md`.
- Nombre: igual al nombre del archivo HU, reemplazando el prefijo `HU-` por `TR-` (conservando sufijos como `-update` o `-update-01`).
