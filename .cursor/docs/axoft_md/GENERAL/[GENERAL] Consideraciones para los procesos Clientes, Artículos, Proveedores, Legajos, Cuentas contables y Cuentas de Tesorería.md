...
- Modulo: General
- Categoria: Operación
- URL: https://ayudas.axoft.com/24ar/documentos/operacion/apertura_oper/excel_oper/excel_consideracion_oper/
...
Para conocer los valores por defecto que asumirá el sistema te sugerimos que pruebes ingresar manualmente un registro; por ejemplo, ingresá al proceso [Artículos](https://ayudas.axoft.com/24ar/articulo_carp_st) y pulsá la opción "Nuevo". Todos los valores por defecto que veas en pantalla serán los mismos que asignemos a las celdas que no completes en el archivo Excel.
