...
- Modulo: Compras
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_cp/guia_comprobajustint_cp/
...
El asistente para [Generación de comprobantes de ajuste](https://ayudas.axoft.com/24ar/genercomprobajuste_cp) le permite cancelar el saldo de comprobantes que hayan quedado pendientes por variaciones en el tipo de cambio de la moneda extranjera o por redondeos no aplicados en el momento del pago.  
...
Previo a poder realizar los comprobantes de ajustes internos por diferencia de cambio y por cancelación de saldos, debe verificar que tenga configurados los siguientes puntos:
  ...
  2. Parámetros de compras: dentro de la solapa Comprobantes de ajustes de la opción [Comprobantes](https://ayudas.axoft.com/24ar/paramgrales_cp/#parametros-para-comprobantes), indique los tipos de comprobante a utilizar para la generación de débitos y créditos de cancelaciones de saldo y diferencias de cambio.
