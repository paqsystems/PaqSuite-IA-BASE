...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_rg5259_gv/
...
Para comenzar a utilizar el circuito debe respetar los siguientes pasos:
  ...
  * Ingrese a [Parámetros de Ventas](?p=19401/#otras-resoluciones) y active la opción Informa remitos electrónicos según la RG 5259 que se encuentra en la solapa Comprobantes electrónicos\Otras resoluciones.
  * Ingrese a [Datos de la empresa](?p=11851) y verifique tener completa la Actividad principal y las Otras actividades de su empresa según los códigos establecidos por AFIP.
...
Para más detalle consulte [Emisión de facturas electrónicas según RG 5259](?p=14650).
