...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_fechalternat_gv/
...
##### Puesta en marcha
  ...
  * Defina el método de cálculo a utilizar, ingresando al menos una [política de interés por mora](https://ayudas.axoft.com/24ar/politicainteresmora_gv).
  * Defina un [tipo de comprobante](https://ayudas.axoft.com/24ar/tipocomprobante_gv) de débito, indicando que registra intereses por mora.
  * Configure en [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-comprobantes) el comportamiento de los datos necesarios para generar las notas de débito por mora en forma automática.
  * Asigne la política de mora a utilizar, pudiendo hacerlo en forma general para todos los clientes asignando un valor en [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes), y/o en las [condiciones de ventas](https://ayudas.axoft.com/24ar/condicionventa_gv) y/o a cada uno de los [clientes](https://ayudas.axoft.com/24ar/clientes_carp_gv).
  * Si la asignación de políticas de mora se realiza en los [clientes](https://ayudas.axoft.com/24ar/clientes_carp_gv) es posible hacerlo en forma masiva desde el asistente para [Asignación masiva de clientes a interés por mora](https://ayudas.axoft.com/24ar/asignacionmasivaclientintxmora_gv) o individualmente en el proceso de [actualización de clientes](https://ayudas.axoft.com/24ar/clientes_carp_gv).
...
##### Contenidos relacionados
  ...
  * [Guía sobre intereses por mora](https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_intermora_gv/)
