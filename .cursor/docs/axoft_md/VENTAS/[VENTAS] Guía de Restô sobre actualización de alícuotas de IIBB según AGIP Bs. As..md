...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv3/guia_alicuotiibb_gv3/
...
Tenga en cuenta que también puede clasificar a los clientes desde los procesos [Clientes](https://ayudas.axoft.com/24ar/clientes_carp_gv) y [Clientes ocasionales](?p=19271#clientesocasionales). Seleccione "Actualizar según padrones" para asignar en forma automática el código de percepción de ingresos brutos que le corresponda de acuerdo al padrón.  
