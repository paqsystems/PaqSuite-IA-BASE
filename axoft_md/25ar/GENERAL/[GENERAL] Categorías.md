...
- Modulo: General
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gla/guia_integrcont_gla/?p=13031/
...
Código de Simplificación registral: ingrese en este campo el código que figura en la tabla publicada por ARCA en el sitio web de Simplificación registral. De utilidad para informar legajos eventuales a través del [Libro de Sueldos Digital](?p=13104). 
