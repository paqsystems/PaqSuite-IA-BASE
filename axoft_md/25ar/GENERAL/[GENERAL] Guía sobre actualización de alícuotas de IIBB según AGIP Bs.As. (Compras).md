...
- Modulo: General
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gla/guia_guiagenerarchpdf_gla/?p=14406/
...
Utilice los archivos de los padrones sin modificar los nombres originales que tienen al ser descargados de la página de Rentas de la Ciudad de Buenos Aires.
  ...
  5. Ingrese al proceso [Actualización de alícuotas de IIBB según AGIP Bs.As.](https://ayudas.axoft.com/25ar/actalicibagpbsas_cp2) para actualizar el padrón del sistema y los códigos de retención de ingresos brutos asociados a cada uno de sus proveedores.



Tenga en cuenta que también puede clasificar a los proveedores desde el proceso [Proveedores](https://ayudas.axoft.com/25ar/proveedores_cp2). Desde el botón "Actualizar según padrones" asignará en forma automática el código de retención de ingresos brutos que le corresponda de acuerdo al padrón.  
...
##### Contenidos relacionados
  ...
  * [Guía sobre actualización de alícuotas de IIBB según AGIP Bs. As. ](https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_alicuotiibb_gv/)
