...
- Modulo: General
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gla/guia_guiacamposadicionales_gla/?p=12000/
...
Campo: el campo adicional se crea por el usuario en el [Administrador general del sistema](?p=9063) desde la opción [Campos adicionales](?p=9077) del [Administrador de Empresas](?p=9067), en donde se define el nombre del mismo.
...
Para más información, consulte la [guía sobre creación, impresión y consulta de campos adicionales](?p=11895).
