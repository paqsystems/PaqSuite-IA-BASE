...
- Modulo: General
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gla/guia_guiagenerarchpdf_gla/?p=19261/
...
Los destinos de impresión disponibles son: 'Pantalla', 'Impresión rápida', 'Acrobat PDF', 'Archivo de texto' y 'Seleccionar impresora para matricial', aquellos que sean por typ grafico se enviarán a Acrobat PDF y se descargan en el directorio defecto para las descargas del navegador.  
No se reimprimirán los remitos exportados ni los anulados. Tampoco aquellos que originalmente se hayan generado con un typ grafico y luego se hayan cambiado a matricial.  
...
Es posible obtener un informe de los remitos seleccionados que no pudieron ser reimpresos. Los motivos por los que un remito no puede ser reimpreso son:
  ...
  * El remito fue ingresado en una versión anterior a la **23.01.000** o fue generado originalmente mediante un typ gráfico y luego se cambió a matricial (se indica: "NO ES POSIBLE REIMPRIMIR EL COMPROBANTE").
...
Pulse la tecla <F6> para ingresar y/o consultar los datos asociados con el transporte o traslado de bienes - Rentas Bs.As. Para más información, consulte en la ayuda o manual del módulo Ventas, el proceso [Modificación de comprobantes](https://ayudas.axoft.com/25ar/modifcomprobante_gv).  
