...
- Modulo: General
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_transfer_reut/guias_gestioncentral_transf_reut/?p=17243/
...
Una vez que el comprobante fue registrado al stock no estará disponible desde el proceso de revisión, pero los puede consultar desde:
  ...
  * la opción [Consulta de comprobantes](https://ayudas.axoft.com/25ar/consultacomprobante_st).
  * el informe [ Movimientos entre sucursales o depósitos con revisión](https://ayudas.axoft.com/25ar/movimimportadorevision_st).
...
Desde los siguientes informes puede obtener la siguiente información:
  ...
  * [Movimientos entre sucursales o depósitos con revisión](https://ayudas.axoft.com/25ar/movimimportadorevision_st): a través de este informe es posible consultar todos los comprobantes que pasaron por el proceso de revisión.
  * [Movimientos de stock importados](https://ayudas.axoft.com/25ar/movimientoimportado_st): a través de este informe es posible consultar todos los comprobantes importados desde otra sucursal.
