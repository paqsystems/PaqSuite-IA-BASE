...
- Modulo: General
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gla/guia_guiagenerarchpdf_gla/?p=26538/
...
A continuación se detallan los pasos a seguir para la asignación de códigos de percepción de ingresos brutos en base al padrón de Rentas.
  ...
  1. Decida como prefiere implementar el impuesto a los ingresos brutos en el sistema. Para más información consulte [¿Cómo me conviene implementar las percepciones de ingresos brutos?](https://ayudas.axoft.com/25ar/guia_pm1_alicuotiibb_gv)
  2. Ingrese al proceso [Alícuotas](https://ayudas.axoft.com/25ar/alicuota_gv) o [Percepciones definibles](https://ayudas.axoft.com/25ar/percepcdefin_gv) según lo definido en el punto anterior y complete para cada percepción el campo Grupo AGIP Para más información sobre este campo consulte [Consideraciones sobre el campo Grupo AGIP](https://ayudas.axoft.com/25ar/guia_pm2_alicuotiibb_gv).  
...
Utilice los archivos de los padrones sin modificar los nombres originales que tienen al ser descargados de la página de Rentas de la Ciudad de Buenos Aires.
  4. Copie el padrón en el directorio comunes del servidor (_\NombreDelServidorCOMUN#########_ , donde ######### representa el número de llave de su sistema).
...
Tenga en cuenta que también puede clasificar a los clientes desde los procesos [Clientes](https://ayudas.axoft.com/25ar/clientes_carp_gv) , [Clientes potenciales](https://ayudas.axoft.com/25ar/clientepotencial_gv) y [Clientes ocasionales](?p=19271#clientesocasionales). Seleccione "Actualizar según padrones" para asignar en forma automática el código de percepción de ingresos brutos que le corresponda de acuerdo al padrón.  
...
Usted puede implementar las percepciones de ingresos brutos mediante alguna de las siguientes opciones:
  ...
  * [Alícuotas](https://ayudas.axoft.com/25ar/alicuota_gv): es la forma básica de definir percepciones de ingresos brutos. Aunque cubre la mayor parte de las necesidades de este impuesto posee algunas limitaciones con respecto a las percepciones definibles.
...
Configure la provincia asociada al padrón de régimen general, para más información consulte el proceso [Parámetros de Ventas](https://ayudas.axoft.com/25ar/paramgrales_gv/#parametros-para-impuestos).
...
##### Contenidos relacionados
  ...
  * [Actualización de alícuotas de IIBB según AGIP Bs. As.](https://ayudas.axoft.com/25ar/ayudas/gv/procperiodico_carp_gv/actaliciibbagipbsas_gv/)

  * [Alícuotas de Ventas](https://ayudas.axoft.com/25ar/ayudas/gv/archivos_carp_gv/actualizacion_carp_gv/alicuota_gv/)

  * [Guía sobre actualización de alícuotas de IIBB según AGIP Bs.As. (Compras)](https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_cp2/guia_actualalicagipbsas_cp2/)
