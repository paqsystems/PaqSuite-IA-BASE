...
- Modulo: General
- Categoria: Operación
- URL: https://ayudas.axoft.com/25ar/documentos/operacion/tablas_oper/tablascompras_oper/
...
COMPROBANTE_IA_COMPRAS| Comprobantes por AI|   
...
CPA07| Documentos|   
CPA08| Retenciones por proveedor| Exclusivo para Argentina  
...
CPA123| Relación renglón solicitud / renglón oden de compra|   
CPA124| Auditoría de motivos de solicitudes|   
CPA127| Relación renglón solicitud / renglón orden de compra / renglón Inventario|   
...
ESTADO_ORDEN_COMPRA| Estado de órdenes de compra|   
...
PERFIL_ADMINISTRADOR_COMPROBANTE_COMPRAS| Perfiles para el administrador de comprobantes por AI|   
PERFIL_ADMINISTRADOR_COMPROBANTE_COMPRAS_USUARIO| Perfiles para el administrador de comprobantes por AI|   
PRECIOS_SOLICITADOS| Guarda información de proveedor/artículo a los cuales se les solicitó cotización de precios.|   
