...
- Modulo: General
- Categoria: Operación
- URL: https://ayudas.axoft.com/25ar/documentos/operacion/apertura_oper/excel_oper/excel_consideracion_oper/?p=17198/
...
Con escalas: indica si utiliza artículos con escalas (por ejemplo: talle y color). En el proceso correspondiente a [Artículos con escalas](https://ayudas.axoft.com/25ar/articulo_carp_st/#escalas) explicamos en detalle su funcionamiento.  
...
Estos valores por defecto se aplicarán únicamente en la carga de artículos nuevos. Si desea definir diferentes valores por defecto (por ejemplo, para diferentes familias de artículos), utilice [Valores por defecto para artículos](https://ayudas.axoft.com/25ar/valordefectoartic_st).
...
En el proceso [Artículos con escalas](https://ayudas.axoft.com/25ar/articulo_carp_st/#escalas) detallamos las especificaciones sobre el uso de escalas.
...
Este valor por defecto se aplicará únicamente en la carga de artículos nuevos. Si desea definir diferentes valores por defecto (por ejemplo, para diferentes familias de artículos), utilice [Valores por defecto para artículos](https://ayudas.axoft.com/25ar/valordefectoartic_st).
...
Valoriza artículos por: si el [Tipo de comprobante](https://ayudas.axoft.com/25ar/tipocomprobante_st) seleccionado fue definido como valorizado, se ingresará un precio unitario. Este permite valorizar el movimiento y afectará los costos del artículo, según la parametrización del tipo de comprobante.
