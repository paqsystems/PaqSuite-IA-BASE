...
- Modulo: General
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gla/guia_rg3572_gla/?p=15550/
...
Estos datos podrá modificarlos según la configuración realizada en [Parámetros contables](https://ayudas.axoft.com/25ar/paramcontparam_cp2) y en caso de utilizar perfiles de facturación, según la configuración realizada en el [perfil de facturación de compras](https://ayudas.axoft.com/25ar/perffacturacp_cp2).
...
RG 3572 - Tipo de Operación: si está activo el [parámetro general RG 3572 - Sujetos vinculados](https://ayudas.axoft.com/25ar/paramgrales_cp2/#principal) y el [proveedor](https://ayudas.axoft.com/25ar/proveedores_cp2) está definido como 'Empresa vinculada'.
...
**Vencimientos**
  ...
  * **Fecha:** el sistema valida que la factura no esté asociada a un pago masivo. En ese caso, es necesario que desvincule la factura del pago masivo desde el proceso [Modificación de pagos masivos](https://ayudas.axoft.com/25ar/pagmasmodificac_cp2), para luego actualizar la fecha de vencimiento.
  * **Importe:** el sistema valida que la factura no esté asociada a un pago masivo. En ese caso, es necesario que desvincule la factura del pago masivo desde el proceso [Modificación de pagos masivos](https://ayudas.axoft.com/25ar/pagmasmodificac_cp2), para luego actualizar el importe de vencimiento.
...
Si en el proceso [Parámetros de Compras](https://ayudas.axoft.com/25ar/paramgrales_cp2/#principal) usted indicó que cumple con la RG 1361 y/o RG 1547, pulse la tecla <F7> para completar o modificar los siguientes datos:
...
Reimpresión de órdenes de pago: si en el proceso [Parámetros de Compras](https://ayudas.axoft.com/25ar/paramgrales_cp2) usted indicó que Reimprime órdenes de pago, utilice la tecla de función <Alt + F11> para realizar la reimpresión.  
...
En el caso que se ingrese una orden de pago a cuenta y luego se le impute a un comprobante, mediante el proceso [Imputación de comprobantes](https://ayudas.axoft.com/25ar/imputacomprobante_cp2) no será posible reimprimir esta orden de pago en función de las imputaciones correspondientes.
...
##### Contenido dependiente
  ...
  * [Comprobantes electrónicos](https://ayudas.axoft.com/25ar/ayudas/cp2/cuentacorriente_carp_cp2/modificomprob_cp2/conscomprobelectr_cp2/)
  * [Comprobantes MiPyMEs](https://ayudas.axoft.com/25ar/ayudas/cp2/cuentacorriente_carp_cp2/modificomprob_cp2/comprobmipymes_cp2/)
