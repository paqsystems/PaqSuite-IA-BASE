...
- Modulo: General
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_transfer_reut/guias_gestioncentral_transf_reut/?p=10235/
...
Código de forma de cobro: permite relacionar la cuenta con un sistema de pagos en línea. Esta opción sólo estará editable si la cuenta es de tipo ‘Otra’, representa fondos, usa moneda corriente y no se tiene configurado un código de billetera virtual para pagos manuales. Para más información, consulte la [Guía de implementación sobre Tango Cobranzas](?p=27349).

Datos para billeteras manuales

Código de billetera virtual: permite relacionar la cuenta con pagos manuales realizados con billeteras virtuales. Esta opción sólo estará editable si la cuenta es de tipo 'Otra', representa fondos, usa moneda corriente y no se tiene configurado un código de forma de cobro para Tango Cobranzas / Tiendas.
