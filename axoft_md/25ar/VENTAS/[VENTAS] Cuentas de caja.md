...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv3/guia_controlart_gv3/?p=24601/
...
Payway: este parámetro se habilita únicamente cuando la cuenta de caja es del tipo 'Otro' o 'Tarjeta' (en este último caso, siempre que también se ingresen los datos del cupón). Tilde esta opción si desea que los cobros realizados mediante la integración con Payway® se asocien automáticamente a esta cuenta, de acuerdo con el circuito definido durante la [puesta en marcha](?p=27406).
