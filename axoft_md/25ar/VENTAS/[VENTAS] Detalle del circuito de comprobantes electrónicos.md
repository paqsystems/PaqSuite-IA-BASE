...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_comprobelectr_gv/guia_dc_comprobelectr_gv/
...
##### Consideraciones generales
  ...
  * Un comprobante puede tener CAE y haber sido 'Observado' por AFIP En ese caso, usted puede consultar el motivo de la observación desde los siguientes procesos (*): 
    * [Administrador de comprobantes electrónicos](https://ayudas.axoft.com/25ar/admindocelectr_gv), solapa Comprobantes autorizados, pulsando en la columna "Observación AFIP".
...
Esta opción se encuentra en el [Administrador de comprobantes electrónicos](https://ayudas.axoft.com/25ar/admindocelectr_gv) y estará disponible según el rol asignado al usuario.  
