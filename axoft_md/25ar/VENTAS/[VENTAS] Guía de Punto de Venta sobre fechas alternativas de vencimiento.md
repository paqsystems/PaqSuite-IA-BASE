# Guía de Punto de Venta sobre fechas alternativas de vencimiento
...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv2/guia_fechalternat_gv2/
...
##### Puesta en marcha
  ...
  * Defina el método de cálculo a utilizar, ingresando al menos una [política de interés por mora](https://ayudas.axoft.com/25ar/politicainteresmora_gv2).
  * Defina un [tipo de comprobante](https://ayudas.axoft.com/25ar/tipocomprobante_gv2) de débito, indicando que registra intereses por mora.
  * Configure en [Parámetros de Ventas](https://ayudas.axoft.com/25ar/paramgrales_gv2/#parametros-para-comprobantes) el comportamiento de los datos necesarios para generar las notas de débito por mora en forma automática.
  * Asigne la política de mora a utilizar, pudiendo hacerlo en forma general para todos los clientes asignando un valor en [Parámetros de Ventas](https://ayudas.axoft.com/25ar/paramgrales_gv2/#parametros-para-clientes), y/o en las [condiciones de ventas](https://ayudas.axoft.com/25ar/condicionventa_gv2) y/o a cada uno de los [clientes](https://ayudas.axoft.com/25ar/clientes_carp_gv2).
  * Si la asignación de políticas de mora se realiza en los [clientes](https://ayudas.axoft.com/25ar/clientes_carp_gv2) es posible hacerlo en forma masiva desde el asistente para [Asignación masiva de clientes a interés por mora](https://ayudas.axoft.com/25ar/asignacionmasivaclientintxmora_gv2) o individualmente en el proceso de [actualización de clientes](https://ayudas.axoft.com/25ar/clientes_carp_gv2).
