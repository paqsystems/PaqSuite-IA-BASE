...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_kit_gv/
...
Para más información consulte la ayuda de [Artículos,](https://ayudas.axoft.com/25ar/articulo_carp_st#composicion) [Categorías](?p=17050) y Fórmulas.
...
**Ingrese a [Artículos](https://ayudas.axoft.com/25ar/articulo_carp_st) para definir los distintos componentes del kit.  
...
Para más información consulte [Administración de precios](?p=19513), [Actualización de precios individual por artículo](https://ayudas.axoft.com/25ar/actualizprecioindivart_gv) o [Actualización global](?p=19180).
...
Si usted trabaja con [Perfiles de facturación](https://ayudas.axoft.com/25ar/itempedidoperfact_gv) puede definir en la ventana de Ítems generales para pedidos si desea ingresar kits sin detallar composición.  
Posteriormente, podrá completar los kits en [Gestión masiva de pedidos](?p=12515), o en el momento de generar la [Facturación](https://ayudas.axoft.com/25ar/facturas_gv)(1) o los [remitos](https://ayudas.axoft.com/25ar/emisionremito_gv)(2), cuando tenga definido que componentes entregará con cada kit.

(1) Siempre que tenga habilitada la opción _Acepta pedidos con kits sin componentes_ del [Perfil de facturación](https://ayudas.axoft.com/25ar/itempedidoperfact_gv).  
...
**Cada vez que se actualizan precios desde los procesos de [Administración de precios](?p=19189), [Actualización de precios individual por artículo](?p=19181), [Actualización global](?p=19180) o [Artículos](https://ayudas.axoft.com/25ar/articulo_carp_st), se consulta si se desean actualizar los precios registrados en los pedidos pendientes que pudiera tener el artículo.  
...
##### Contenidos relacionados
  ...
  * [Actualización de fórmulas y otros costos](https://ayudas.axoft.com/25ar/ayudas/st/archivos_carp_st/actualizacion_carp_st/formulas_st-2/formulas_st/)

  * [Artículos](https://ayudas.axoft.com/25ar/ayudas/st/archivos_carp_st/actualizacion_carp_st/articulo_carp_st/)

  * [Categorías para kits variables](https://ayudas.axoft.com/25ar/ayudas/st/archivos_carp_st/actualizacion_carp_st/formulas_st-2/categoriakitsvariable_st/)
