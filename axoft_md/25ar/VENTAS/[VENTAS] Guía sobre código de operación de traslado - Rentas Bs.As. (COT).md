# Guía sobre código de operación de traslado - Rentas Bs.As. (COT)
...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_codopertraslad_gv/
...
Toda esta información se verá reflejada en el proceso [Generación Archivo Transporte de Bienes - Rentas Bs. As.](https://ayudas.axoft.com/25ar/genarchtranspbienrentbsas_gv), disponible en Informes | Información impositiva.

**Parámetros de Ventas  
**Como primera medida, ingrese a [Empresa](https://ayudas.axoft.com/25ar/paramgrales_gv/#parametros-para-empresa) dentro del proceso [Parámetros de Ventas](https://ayudas.axoft.com/25ar/paramgrales_gv), para ingresar los datos relacionados a su domicilio. Desde la solapa Comprobantes, sub-solapa Transporte de bienes (COT), active el parámetro Genera Remitos Electrónicos y tilde las opciones Edita importe total sin impuestos y Edita cantidad total de kilos.  
...
**Desde Archivos | Actualizaciones del proceso [Transportes](https://ayudas.axoft.com/25ar/transporte_gv) del módulo Ventas ingrese la información correspondiente al domicilio, la categoría frente al IVA y el número de CUIT de los transportistas.

**Configuración de artículos  
**Desde el módulo Stock, en la solapa Datos Legales del el proceso [Artículos](https://ayudas.axoft.com/25ar/articulo_carp_st#datoslegales), complete los datos requeridos por Rentas Bs. As. para la generación de remitos electrónicos.  
...
Para más información, consulte en la ayuda o en el manual del módulo Stock, la explicación correspondiente al proceso [Artículos](https://ayudas.axoft.com/25ar/articulo_carp_st), para el ítem Transporte de Bienes - Rentas Bs.As.  
...
Una vez que reciba la dirección de URL, el código de usuario y la contraseña para conectarse con el sitio de Rentas Bs.As., ingrese al proceso [Generación Archivo Transporte de Bienes - Rentas Bs. As.](https://ayudas.axoft.com/25ar/genarchtranspbienrentbsas_gv), disponible en Informes | Archivos DGI, haga clic en el comando Configuración y registre estos datos en la solapa Rentas.  
