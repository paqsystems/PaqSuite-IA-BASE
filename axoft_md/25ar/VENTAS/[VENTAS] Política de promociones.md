...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_promociones_gv/?p=19420/
...
_Ejemplo de 2 promociones generales combinables:_
...
_Ejemplo de 2 promociones generales condicionales (no combinables):_
...
_Ejemplo de 1 promoción general y 1 por artículo combinable:_
...
_Ejemplo de 1 promoción general y 1 por artículo condicional:_
...
_Ejemplo de 2 promociones por artículo de distinto tipo (combinables):_
...
_Ejemplo de 2 promociones por artículo de distinto tipo para un mismo artículo (no combinable):_
...
_Ejemplo de 2 promociones por artículo del mismo tipo para un mismo artículo (no acumulables):_
...
Por otra parte, si posee pedidos con promociones aplicadas vigentes y deshabilita la opción Utilizar promociones, estas no serán tenidas en cuenta al momento de facturar.  
