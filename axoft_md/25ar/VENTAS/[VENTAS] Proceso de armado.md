...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_kit_gv/?p=17237/
...
El Tipo de comprobante habrá sido definido previamente en el proceso [Tipos de comprobante](https://ayudas.axoft.com/25ar/tipocomprobante_st) y corresponderá a un Tipo de movimiento = 'A' (armado).
...
Para los artículos de tipo insumo: si se configuró el [parámetro](https://ayudas.axoft.com/25ar/parametrogeneral_st) Criterio de búsqueda habitual de partidas y series en comprobantes de egreso como estricto o flexible, los siguientes parámetros se interpretan de la siguiente manera:
...
El orden de carga de series y partidas que se configura desde [Parámetros de Stock](https://ayudas.axoft.com/25ar/parametrogeneral_st) no será tenido en cuenta en el proceso de armado y tampoco podrá ser modificado desde el proceso de armado.  
...
Si algunos artículos se compran y venden y otros se arman, es de utilidad generar en el armado, el precio de última compra y el de reposición. De este modo, para los informes de [Valorización](https://ayudas.axoft.com/25ar/valorizexistencias_st) y [Costo de Ventas](https://ayudas.axoft.com/25ar/costoventas_st) se podrán utilizar uno de estos criterios. Así, se valorizarán los artículos que se arman por el costo estándar, que será igual al precio de reposición.
...
Tenga en cuenta que las cantidades brutas en la fórmula son las que se considerarán para la descarga del stock. Luego, desde el [Listado de scrap](https://ayudas.axoft.com/25ar/listadoscrap_st), podrá consultar las cantidades correspondientes a scrap.
...
**Ejemplo...**  
Para el lavarropas definido en el proceso [Fórmulas](https://ayudas.axoft.com/25ar/formulas_st), se asignan los costos (expresados en pesos) de los insumos, de la siguiente forma:
