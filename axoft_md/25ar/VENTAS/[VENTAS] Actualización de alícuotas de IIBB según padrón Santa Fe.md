...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gla/guia_alicuotiibbsantafe_gv3/?p=18476/
...
**Pasos a seguir para actualizar las alícuotas**
  ...
  2. Ingrese a este asistente y tilde las opciones: 
     ...
     * **Actualizar alícuotas de clientes:** este paso sólo es necesario cuando desee aplicar la alícuota de percepción de ingresos brutos a las direcciones de entrega de cada cliente.
...
##### Contenidos relacionados
  ...
  * [Guía sobre actualización de alícuotas de IIBB según padrón de Santa Fe](https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gla/guia_alicuotiibbsantafe_gv3/)
