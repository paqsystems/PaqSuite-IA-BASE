...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv3/guia_percepdefin_gv3/?p=13099/
...
Método de acumulación de la base de cálculo: indica si la acumulación es:
  ...
  * **Diaria:** indica que el cálculo de la percepción se realiza sobre el total de la base imponible acumulados del día, en el caso que ingrese.
...
Esta opción solo será tenida en cuenta en aquellos comprobantes generados desde Facturador y para aquellas percepciones con las bases de cálculo 'Neto gravado' y 'Neto gravado + Exento'.
