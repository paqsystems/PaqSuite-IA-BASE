...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_pedidos_gv/?p=34562/
...
En esta solapa del proceso encontrará las API que tiene habilitadas:

  * Licencia con API ABMs y consultas Live.
  * Licencia con API Transacciones Tango Contabilidad.
  * Licencia con API Transacciones Tango Ventas.



Para más información contáctese con su distribuidor o ejecutivo de cuenta.
