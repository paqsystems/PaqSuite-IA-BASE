...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_ivasimple_gv/?p=17254/
...
El módulo Ventas Punto de Ventas:
  ...
  * No incluye la [gestión de clientes](?p=21169) (disponible en Ventas de Tango Gestión).
...
A continuación, sugerimos el orden correcto de carga:
  ...
  1. [Parámetros de Stock](https://ayudas.axoft.com/25ar/parametrogeneral_st)
  ...
  3. [Longitud de agrupaciones](https://ayudas.axoft.com/25ar/longitagrupacion_st)
  4. [Agrupaciones de artículos](https://ayudas.axoft.com/25ar/agrupacionartic_st)
  5. [Escalas](?p=17077)
  6. [Artículos](https://ayudas.axoft.com/25ar/articulo_carp_st)
  7. [Depósitos](https://ayudas.axoft.com/25ar/deposito_st)
  ...
  9. [Tipos de comprobante](https://ayudas.axoft.com/25ar/tipocomprobante_st): se refiere exclusivamente a los comprobantes que actualizarán stock desde este módulo. No se relaciona con los comprobantes que afectan stock desde los módulos Ventas o Compras en forma automática.
...
Los pasos para utilizar las funciones de armado son:
  ...
  1. [Componentes de costos](https://ayudas.axoft.com/25ar/componentecosto_st): estas componentes no son obligatorias.
  2. [Fórmulas](https://ayudas.axoft.com/25ar/formulas_st).
  3. [Tipo/s de comprobante](https://ayudas.axoft.com/25ar/tipocomprobante_st) especial para armado: se definirá un tipo de comprobante especial para registrar los movimientos de stock por armado.
...
Para implementar correctamente el cálculo de PPP es necesario:
  ...
  1. Indicar que utiliza precio promedio ponderado en el proceso [Parámetros de Stock](https://ayudas.axoft.com/25ar/parametrogeneral_st).
...
Para ingresar el valor inicial de PPP existen dos opciones:
  ...
  * Si no existen movimientos de stock, las opciones posibles son: 
    * Ingresar el valor de PPP inicial como precio del artículo, al realizar la carga inicial de stock mediante un [ingreso a stock](https://ayudas.axoft.com/25ar/ingresostock_st) o [ajuste de inventario](https://ayudas.axoft.com/25ar/ajusteinventario_st) valorizados (que afecte PPP).
    * Ingresar manualmente el PPP inicial para cada artículo en el proceso [Actualización individual de PPP](https://ayudas.axoft.com/25ar/pppactualizacionindividual_st).
  * Si existen movimientos de stock: 
    * En este caso se debe ingresar manualmente el PPP inicial para cada artículo en el proceso [Actualización individual de PPP](https://ayudas.axoft.com/25ar/pppactualizacionindividual_st).
...
##### Contenido dependiente
  ...
  * [Archivos](https://ayudas.axoft.com/25ar/ayudas/st/archivos_carp_st/)
  * [Movimientos](https://ayudas.axoft.com/25ar/ayudas/st/movimiento_carp_st/)
  * [Procesos periódicos](https://ayudas.axoft.com/25ar/ayudas/st/procesoperiodico_carp_st/)
  * [Informes](https://ayudas.axoft.com/25ar/ayudas/st/informes_carp_st/)
  * [Análisis Multidimensional](https://ayudas.axoft.com/25ar/ayudas/st/analmultidimensional_st/)
  * [Modelos de impresión de comprobantes en Stock](https://ayudas.axoft.com/25ar/ayudas/st/modeloimpresioncomprob_st/)
