...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv2/guia_comprobelectr_gv2/
...
Al cambiar a la versión 2 de webservices es necesario que asigne el código AFIP a las [alícuotas,](https://ayudas.axoft.com/25ar/alicuota_gv2) [monedas](?p=11955) y [percepciones definibles](https://ayudas.axoft.com/25ar/percepcdefin_gv2) antes de facturar.
...
Tenga en cuenta las siguientes indicaciones al cambiar de versión 0 a versión 2 de webservice:
  ...
  1. Invoque el proceso [Parámetros de Ventas](https://ayudas.axoft.com/25ar/paramgrales_gv2) para registrar la versión de webservices a utilizar.  
...
Si existen comprobantes electrónicos sin CAE, ejecute el proceso [Administración de Comprobantes Electrónicos](https://ayudas.axoft.com/25ar/admincomprelectr_gv2) y obtenga el CAE de los comprobantes electrónicos pendientes / rechazados.  
Una vez obtenido el CAE de todos los comprobantes, cambie de versión de webservice desde la solapa Comprobantes electrónicos de [Parámetros de Ventas](https://ayudas.axoft.com/25ar/paramgrales_gv2).
  2. Desde el proceso [Alícuotas](https://ayudas.axoft.com/25ar/alicuota_gv2) indique, para cada una de las alícuotas, el código de tributo definido por AFIP.
  3. Si usted aplica [Percepciones definibles](https://ayudas.axoft.com/25ar/percepcdefin_gv2) defina para cada una de ellas, el código habilitado por AFIP.
...
Ingrese a la solapa Empresa del proceso [Parámetros de Ventas](https://ayudas.axoft.com/25ar/paramgrales_gv2) y complete y/o verifique los datos particulares de su empresa (razón social, domicilio, fecha de inicio de actividades y número de inscripción en Ingresos Brutos).  
Luego, ingrese a la solapa [Comprobantes electrónicos](https://ayudas.axoft.com/25ar/modifcomprobelectr_gv2) del proceso [Parámetros de Ventas](https://ayudas.axoft.com/25ar/paramgrales_gv2) y complete los siguientes datos:
...
Complete los siguientes datos:
  ...
  * Seleccione el Webservices a utilizar: 
    ...
    * Si usted cumple con la RG 2557/09 para la emisión de comprobantes electrónicos con aplicación de Bonos Fiscales Electrónicos (según Decreto Nº 2316/08), el webservice a utilizar lo determina el [talonario](https://ayudas.axoft.com/25ar/talonario_gv2) asociado al comprobante electrónico.
    * Sin embargo, elija un Webservice de referencia, teniendo en cuenta las siguientes consideraciones: 
...
Si necesita aplicar una parametrización especial a uno o más clientes, defina esta configuración en la ficha de cada cliente. Para más información, consulte el ítem [Clasificación de los clientes](https://ayudas.axoft.com/25ar/modifcomprobelectr_gv2).
...
Por ejemplo, seleccione 'Mes Anterior' si su empresa factura el primer día de cada mes, los servicios brindados el mes anterior.
  ...
  * Si esta alcanzado por RG 3749 o RG 4004 E (reemplazo de regímenes informativos): 
    * Ingrese a la solapa Otras resoluciones ubicada en [Comprobantes electrónicos](https://ayudas.axoft.com/25ar/modifcomprobelectr_gv2) de [Parámetros de Ventas](https://ayudas.axoft.com/25ar/paramgrales_gv2) (dicha opción estará habilitada únicamente si el web service seleccionado es 'Versión 2').
...
En la pantalla de [Administración de Comprobantes Electrónicos](https://ayudas.axoft.com/25ar/admincomprelectr_gv2), ingrese a Parámetros y coloque los datos de conexión.
...
Ingrese al proceso [Provincias](https://ayudas.axoft.com/25ar/provincia_gv2) y controle que la codificación asignada en Clasificación AFIP sea la correcta para cada una de las provincias definidas.  
...
Si usted genera comprobantes electrónicos de exportación (RG 3066), invoque el proceso [Países](https://ayudas.axoft.com/25ar/pais_gv2) del módulo Ventas y complete la clasificación AFIP con el código que este organismo asigna a cada país.
...
Ingrese al proceso [Talonarios](https://ayudas.axoft.com/25ar/talonariocomprobelectr_gv2) y defina los talonarios (nuevos puntos de venta solicitados en AFIP) a utilizar durante la generación de comprobantes electrónicos.  
...
Al definir un talonario de comprobantes electrónicos, tenga en cuenta las siguientes consideraciones:
  ...
  * Si cumple con la RG 3066, diseñe sus formularios incluyendo las [palabras de control para comprobantes electrónicos de exportación](https://ayudas.axoft.com/25ar/var_palabcontrol_gv2) y las [palabras de reemplazo para comprobantes electrónicos de exportación](https://ayudas.axoft.com/25ar/variables_gv2).
...
Por defecto, el sistema considera lo definido en la solapa Comprobantes electrónicos del proceso [Parámetros de Ventas](https://ayudas.axoft.com/25ar/paramgrales_gv2).
...
Para cada [alícuota](https://ayudas.axoft.com/25ar/alicuota_gv2) ingresada en el sistema, indique cuál es el código definido por AFIP.  
Realice este paso si emite comprobantes electrónicos del mercado interno.

_**11\. Codificación de percepciones definibles**_

Para cada [percepción definible](https://ayudas.axoft.com/25ar/percepcdefin_gv2), seleccione el código definido por AFIP.  
Realice este paso si emite comprobantes electrónicos del mercado interno.
...
Estos campos determinan el comportamiento de los ítems Actividad a informar y Tipo de actividad en los procesos de [Facturación](https://ayudas.axoft.com/25ar/facturas_gv2) y [Pedidos](https://ayudas.axoft.com/25ar/ingresopedido_gv2).
...
Estos campos controlan el comportamiento de los campos Actividad a informar y Tipo de actividad en los procesos de [emisión de notas de crédito](https://ayudas.axoft.com/25ar/emisionc_gv2).
...
A continuación, enumeramos los pasos necesarios para poner en marcha el circuito de comprobantes electrónicos T (de turismo):
  ...
  * **Parámetros de ventas:** ingresando a [Parámetros de Ventas](https://ayudas.axoft.com/25ar/paramgrales_gv2), dentro de la solapa [Comprobantes electrónicos](https://ayudas.axoft.com/25ar/paramgrales_gv2/#parametros-para-comprobantes-electronicos), sub-solapa Resoluciones, habilite la opción Genera información RG 3971.
  * **Definición de talonarios:** ingrese a [Talonarios](https://ayudas.axoft.com/25ar/talonario_gv2) y defina los talonarios electrónicos tipo 'T' a utilizar durante la generación de comprobantes indicando el nuevo punto de venta asignado por AFIP.  
...
Luego de completar los [pasos previos que todo cliente debe realizar ante la AFIP](?p=26876) y los de la generación de un Comprobante de Crédito electrónico, utilice los procesos indicados para poner en marcha el circuito de comprobante de créditos electrónicos:
  ...
  * **Parámetros de ventas:** ingrese a [Parámetros de Ventas](https://ayudas.axoft.com/25ar/paramgrales_gv2), dentro de la solapa Comprobantes electrónicos, sub-solapa Otras resoluciones, defina el CBU del emisor (dato obligatorio para la generación de este tipo de comprobantes).
  * **Talonarios:** ingrese al proceso [Talonarios](https://ayudas.axoft.com/25ar/talonariocomprobelectr_gv2) y defina los talonarios (nuevos puntos de venta solicitados en AFIP) a utilizar durante la generación de comprobantes de crédito electrónicos.  
...
Para generar un comprobante de crédito electrónico:
  ...
  * Seleccione un [talonario](https://ayudas.axoft.com/25ar/talonariocomprobelectr_gv2) que tenga activado el parámetro Comprobante de crédito electrónico.
  * Seleccione una [condición de venta](https://ayudas.axoft.com/25ar/condicionventa_gv2) de contado, o con una cuota.
...
##### Consideraciones generales
  ...
  * Un comprobante puede tener CAE y haber sido 'Observado' por AFIP En ese caso, usted puede consultar el motivo de la observación desde los siguientes procesos (*): 
    * [Administrador de comprobantes electrónicos](https://ayudas.axoft.com/25ar/admindocelectr_gv2), solapa Comprobantes autorizados, pulsando en la columna "Observación AFIP".
...
Esta opción se encuentra en el [Administrador de comprobantes electrónicos](https://ayudas.axoft.com/25ar/admindocelectr_gv2) y estará disponible según el rol asignado al usuario.  
