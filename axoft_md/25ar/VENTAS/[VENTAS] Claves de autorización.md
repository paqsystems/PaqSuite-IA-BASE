...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv2/guia_precio_gv2/?p=19233/

## Contenido

# Claves de autorización

Si trabaja con [perfiles de pedidos](https://ayudas.axoft.com/25ar/perfpedido_gv), con [perfiles de facturación](https://ayudas.axoft.com/25ar/perfilfacturacion_gv), con [perfiles de notas de crédito](https://ayudas.axoft.com/25ar/perfilnotacredito_gv) y/o con [perfiles de remitos](https://ayudas.axoft.com/25ar/perfilremito_gv), puede definir permisos eventuales para que un usuario determinado (mediante una clave temporal) autorice la modificación de ciertos campos (con restricciones para ese perfil) durante el ingreso de una factura o un pedido, de una nota de crédito o bien, de un remito.
...
Los usuarios autorizantes deben tener asociado un [perfil de pedidos](https://ayudas.axoft.com/25ar/perfpedido_gv), [perfil de facturación](https://ayudas.axoft.com/25ar/perfilfacturacion_gv), [perfil de nota de crédito](https://ayudas.axoft.com/25ar/perfilnotacredito_gv) y un [perfil de remito](https://ayudas.axoft.com/25ar/perfilremito_gv) (si corresponde) en los que se haya elegido la opción 'Edita' para los datos a autorizar.  
...
Puede visualizar las aprobaciones realizadas mediante el informe [Auditoría de autorizaciones](https://ayudas.axoft.com/25ar/auditorautoriz_gv).  
Para más información, consulte el proceso [Perfiles de pedidos](https://ayudas.axoft.com/25ar/perfpedido_gv), [Perfiles de facturación](https://ayudas.axoft.com/25ar/perfilfacturacion_gv), [Perfiles de notas de crédito](https://ayudas.axoft.com/25ar/perfilnotacredito_gv), [Perfiles de remitos](https://ayudas.axoft.com/25ar/perfilremito_gv) o la [guía de implementación sobre perfiles](?p=27001).
