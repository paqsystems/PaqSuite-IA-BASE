...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_constprovisretencion_gv/
...
Desde el proceso [Códigos de retención](https://ayudas.axoft.com/25ar/codigoretenc_gv), disponible desde Archivos | Actualizaciones, usted puede agregar, consultar, listar y modificar los códigos de retención.  
Este código le permitirá ingresar, desde el proceso [Cobranzas](https://ayudas.axoft.com/25ar/ingresocobranza_gv) o durante la [Modificación de comprobantes](https://ayudas.axoft.com/25ar/modifcomprobante_gv) las [Constancias provisionales de retención](https://ayudas.axoft.com/25ar/constprovisretencion_gv) implementadas por la Resolución General 2426/2008.
...
##### Contenidos relacionados
  ...
  * [Códigos de retención](https://ayudas.axoft.com/25ar/ayudas/gv/archivos_carp_gv/actualizacion_carp_gv/codigoretenc_gv/)
