# Guía de implementación sobre RG 5762/25 - Factura A con retención (Reemplazo de Factura M)
...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_rg5762_gv/
...
Para más información sobre definición de talonarios, consulte la ayuda de [Definición de talonarios](https://ayudas.axoft.com/25ar/talonario_gv).  
Para más información sobre configuración de formularios de comprobantes de ventas, consulta la ayuda de [Formularios de ventas](?p=11875).  
