...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_cuentcorr_gv/?p=19319/
...
El sistema controlará los importes en los procesos de ingreso de comprobantes, si exceden el crédito disponible, el sistema emite un mensaje o bien no permite su ingreso, según la parametrización del perfil. Para más información, consulte el proceso [Perfiles de facturación](https://ayudas.axoft.com/25ar/perfilfacturacion_gv).
...
Una vez que defina los grupos empresarios con los que trabaja, indique los clientes que los integran. Debe realizar esta tarea en el proceso [Clientes](https://ayudas.axoft.com/25ar/clientes_carp_gv).  
...
Puede ingresar recibos de cobranzas involucrando comprobantes de distintos clientes del grupo empresario. Para modificar las imputaciones realizadas utilice el proceso [Imputación de comprobantes](https://ayudas.axoft.com/25ar/imputcomprobante_gv).
