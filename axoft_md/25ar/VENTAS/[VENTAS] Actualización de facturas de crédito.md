...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_factcred_gv/?p=21128/
...
El sistema actualizará, automáticamente, el estado de la factura de crédito a 'Cobrada' y los datos del comprobante de egreso durante el proceso [Cancelación de Facturas de Crédito](https://ayudas.axoft.com/25ar/cancfacturacredito_gv).  
...
Este dato se genera en forma automática desde el proceso [Cobranzas](https://ayudas.axoft.com/25ar/ingresocobranza_gv) al registrar el recibo de aceptación.
