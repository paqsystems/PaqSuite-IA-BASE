...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_pedidos_gv/?p=19413/

## Contenido

# Perfiles de aprobación

Este proceso actualiza los perfiles de aprobación para los distintos usuarios. Usted tendrá acceso a este proceso sólo si está activa la aprobación de pedidos.

La definición de perfiles no es obligatoria. De no existir ningún perfil definido, se tendrá en cuenta lo definido como [Parámetros de Ventas](https://ayudas.axoft.com/25ar/paramgrales_gv/#parametros-para-clientes).  
...
Archivo de pieles: ingrese la ubicación y nombre del archivo (con extensión .bmp) a utilizar como fondo de pantalla (pieles).  
