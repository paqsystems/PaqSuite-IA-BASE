...
- Modulo: Activo Fijo
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_afa/guia_administracionbienes/?p=11882/
...
La explicación de cada uno de los procesos del módulo se detalla a partir del capítulo [Empleados](?p=11950).
...
Para ubicar rápidamente los procesos citados en la ayuda, recuerde que la función _Buscar_ (ubicada en el menú del sistema, se activa pulsando la tecla _< F3>_) permite realizar una búsqueda de un texto en el árbol de procesos de todos los módulos. Como resultado, se exhibirá el nombre de los procesos que incluyen el texto ingresado, con la indicación del módulo y carpeta en la que se encuentran.

**Si usted instaló el módulo Contabilidad:**

  1. [Leyendas para encabezados de asientos](?p=11951)
  2. [Leyendas para líneas de asientos](?p=11952)
  3. [Agrupaciones de tipos de asiento](?p=11830)
  4. [Tipos de asiento](?p=11994)
  5. [Auxiliares contables](?p=11835)
  6. [Reglas de apropiación](?p=11974)
...
**Si usted instaló el módulo Sueldos:**
  ...
  3. [Agrupaciones auxiliares](?p=11829)
  4. [Motivos de egreso](?p=11957)
  5. [Valores por defecto para legajos](https://ayudas.axoft.com/20ar/importar/gla/caractgenerales_gla/puestamarcha_gla/)
  6. [Feriados](?p=11867)
  7. [Bancos](?p=11836)
...
**Si usted instaló el módulo Control de personal:**
  ...
  2. [Departamentos](?p=11852)
  3. [Agrupaciones auxiliares](?p=11829)
  4. [Valores por defecto para legajos](?p=11999)
  5. [Feriados](?p=11867)
...
**Si usted instaló el módulo Activo Fijo**
  ...
  1. [Monedas](?p=11956)
  2. [Parámetros generales](?p=12044)
  3. [Cuentas](?p=11850)
  4. [Tipos de asientos](?p=11994)
  5. [Auxiliares contables](?p=11969)
  6. [Reglas de apropiación](?p=11974)
  7. [Departamentos](?p=11852)
...
Para obtener más información sobre cómo parametrizar el sistema, consulte la ayuda del proceso [Parámetros generales](?p=12044).
...
Recuerde que puede agilizar el ingreso de datos del legajo utilizando los procesos [Actualización masiva de legajos](?p=11828) y [Valores por defecto para legajos](?p=11828).
...
##### Contenido dependiente
  ...
  * [Tablas generales](https://ayudas.axoft.com/25ar/ayudas/gla/tablasgrales_carp_gla/)
  * [Datos contables](https://ayudas.axoft.com/25ar/ayudas/gla/datoscontabl_carp_gla/)
  * [Empleados](https://ayudas.axoft.com/25ar/ayudas/gla/empleados_carp_gla/)
  * [Transferencias](https://ayudas.axoft.com/25ar/ayudas/gla/transferencias_carp_gla/)
  * [Auditoría](https://ayudas.axoft.com/25ar/ayudas/gla/auditoria_gla/)
  * [Padrones](https://ayudas.axoft.com/25ar/ayudas/gla/padron_carp_gla/)
  * [WhatsApp](https://ayudas.axoft.com/25ar/ayudas/gla/whatsapp_carp_gla/)
  * [Informes sobre soporte magnético](https://ayudas.axoft.com/25ar/ayudas/gla/soportemagnetico_gla/)
  * [Tango AI](https://ayudas.axoft.com/25ar/ayudas/gla/tangoai_carp_gla/)
