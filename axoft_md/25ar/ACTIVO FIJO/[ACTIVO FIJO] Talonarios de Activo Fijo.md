...
- Modulo: Activo Fijo
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_afa/guia_administracionbienes/?p=5953/

## Contenido

# Talonarios de Activo Fijo

Este proceso permite definir los distintos talonarios a utilizar desde la [Registración de movimientos](?p=6749).

La asignación de talonarios facilita el seguimiento y el control de movimientos.

Todos los [tipos de movimientos](?p=5954) pueden tener un talonario habitual.
...
Usted puede definir un talonario por tipo de movimiento o un único talonario para todos los [tipos de movimientos](?p=5954).
