...
- Modulo: Activo Fijo
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_afa/guia_administracionbienes/?p=5908/

## Contenido

# Conceptos

Usted puede definir Concepto predeterminadas para la [Registración de movimientos](?p=6749).

Todos los [tipos de movimientos](?p=5954) pueden tener un concepto habitual.
