...
- Modulo: Sueldos
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_sua/guia_puestamarcha_sua/?p=13103/
...
A partir de Delta 4 se permite guardar historial de Lugar de pago y Sindicato.
...
Es posible consultar y modificar los datos de historiales generados desde el proceso [Historial laboral](?p=13137).  
Para controlar y obtener los cambios en un período de tiempo especificado, utilice el informe [Historial laboral de empleados](https://ayudas.axoft.com/desarrollo/ayudas/sua/informes_carp_sua/infempleado_carp_sua/).

##### Legajos

Utilice el [Seleccionador de legajos](?p=11882/#definiciones-previas) para conformar el conjunto de legajos cuyo historial desea obtener.
