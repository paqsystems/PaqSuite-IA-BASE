...
- Modulo: Sueldos
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_sua/guia_puestamarcha_sua/?p=11950/
...
Los datos de cada legajo se distribuyen en diferentes solapas las cuales se detallan a continuación:
  ...
  * [Principal](?p=13153) (con los datos de identificación del empleado).
  * [Contacto](?p=13153/#contacto) (con los datos de domicilio y teléfonos del empleado).
  * [Laboral](?p=13153/#laboral) (con los datos de contratación laboral y afiliaciones).
  * [Pago](?p=13153/#pago) (con los datos de la remuneración y unidades para el pago de haberes).
  * [Agrupaciones](?p=13153/#agrupaciones) (con los datos de clasificación del empleado).
  * [Sicoss](?p=13153/#sicoss) (con los datos de para Sicoss del empleado).
...
Si necesita actualizar uno o varios campos en particular utilice el proceso [Actualización masiva de legajos](?p=11828). Por ejemplo, de esta forma puede asignar convenios, categorías, códigos de obras sociales, modalidades de contratación, entre otros.  
Tenga en cuenta que, además, es posible actualizar información, mediante la exportación / importación de datos desde Excel.  
Para más información acerca de [Legajos](?p=13153) del módulo de **Sueldos** y [Legajos](?p=11489) de **Control de personal** consulte la ayuda respectiva en los manuales de dichos módulos.
...
##### Contenidos relacionados
  ...
  * [Guía sobre cómo trabajar con Sueldos](https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_sua/guia_puestamarcha_sua/)
