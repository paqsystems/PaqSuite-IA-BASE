...
- Modulo: Stock
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_st/guia_unidadmedida_st/?p=17035/
...
Puede evitar el ingreso de datos comunes a varios artículos utilizando [plantillas](https://ayudas.axoft.com/25ar/valordefectoartic_st). Por ejemplo, puede definir una plantilla denominada "Notebook" con los siguientes datos por defecto:
...
Si necesita actualizar un determinado campo a un grupo de artículos utilice el proceso [Actualización masiva de artículos](https://ayudas.axoft.com/25ar/actualizmasivartic_st). Por ejemplo, de esta forma puede asignar un grupo de artículos a una clasificación determinada para informes y estadísticas o indicar una nueva configuración impositiva a otro grupo. Además de esta forma de actualizar información, puede hacerlo mediante la exportación / importación de datos desde Excel.
...
Código de plantilla: indica la plantilla a utilizar. Para mayor información, consulte [Plantillas](https://ayudas.axoft.com/25ar/plantilla_st).

Código de escala 1 y Código de escala 2: indican el código de la escala. Dichas escalas contienen valores previamente definidos por el usuario. Para mayor información, consulte [Escalas](https://ayudas.axoft.com/25ar/longitagrupacion_st/#escalas).  
...
Los parámetros correspondientes a doble unidad de medida, que se detallan a continuación, estarán visibles al activar el parámetro general Lleva doble unidad de medida del proceso [Parámetros de Stock](https://ayudas.axoft.com/25ar/parametrogeneral_st).
...
Código de IVA: indica el código del impuesto. Para más información acceda a la ayuda de [Configuración impositiva](https://ayudas.axoft.com/25ar/configimpositiva_st).
...
Para mas información acerca de la configuración de alícuotas, consulte [Configuración impositiva](https://ayudas.axoft.com/25ar/configimpositiva_st).
...
Por defecto, estos campos tomarán los valores indicados en [Parámetros de Stock](https://ayudas.axoft.com/25ar/parametrogeneral_st), de manera que sólo se modificarán los casos especiales.  
...
Para actualizar en forma masiva información de transporte de bienes, consulte [Actualización global de códigos de Rentas](https://ayudas.axoft.com/25ar/actglobalcodrentasbsas_st).
...
Ejecute el proceso [Actualización global de códigos de AFIP](https://ayudas.axoft.com/25ar/actualizglobalcodafip_st) para actualizar o eliminar en forma masiva, los datos de sus comprobantes electrónicos.  
...
Puede realizar esta asignación desde el proceso [Actualización masiva de artículos](https://ayudas.axoft.com/25ar/actualizmasivartic_st).  
...
Ventas: indica los códigos, asociados a la clasificación habitual del artículo, válidos para Ventas. Para mayor información, consulte [Configuración impositiva](https://ayudas.axoft.com/25ar/configimpositiva_st).

Compras: indica los códigos, asociados a la clasificación habitual del artículo, válidos para Compras. Para mayor información, consulte [Configuración impositiva](https://ayudas.axoft.com/25ar/configimpositiva_st).
...
Los pasos a seguir son los siguientes:
  ...
  * Ingrese a [Artículos](https://ayudas.axoft.com/25ar/articulo_carp_st) y elija la opción 'Generar plantilla de importación desde Excel'.
...
Para ello, desde el proceso [Artículos](https://ayudas.axoft.com/25ar/articulo_carp_st) o bien, desde el [Administrador de campos adicionales](?p=9077), defina los campos necesarios para la gestión de su empresa.  
...
Para más información, consulte el proceso [Plantillas para el alta de artículos con escalas](https://ayudas.axoft.com/25ar/plantilla_st).
...
##### Contenidos relacionados
  ...
  * [Video sobre administración de artículos](https://ayudas.axoft.com/25ar/videos/st_carp_vid/adminarticulos_st_vid/)
  ...
  * [Video sobre artículos pesables](https://ayudas.axoft.com/25ar/videos/gral_carp_vid/artpesable_gral_vid/)
  ...
  * [Video sobre parámetros de stock](https://ayudas.axoft.com/25ar/videos/st_carp_vid/parametrostock_st_vid/)

  * [Video sobre regímenes de facturación](https://ayudas.axoft.com/25ar/videos/gral_carp_vid/regfact_gral_vid/)

  * [Video sobre remitos de compra desde Tango Colectora](https://ayudas.axoft.com/25ar/videos/cp2_carp_vid/colectora_cp2_vid/)

  * [Video sobre tarjetas de regalo](https://ayudas.axoft.com/25ar/videos/gral_carp_vid/tarjregalo_gral_vid/)
