...
- Modulo: Stock
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_st2/guia_dobleum_st2/
...
Habilite el uso de doble unidad de medida desde [Parámetros de Stock](https://ayudas.axoft.com/25ar/parametrogeneral_st2). A partir de esta configuración podrá definir artículos con esta funcionalidad

Ingrese al proceso [Artículos](https://ayudas.axoft.com/25ar/articulo_carp_st2) y habilite el parámetro Lleva doble unidad de medida en el artículo.
...
En los comprobantes generados en el módulo Stock la unidad de medida en la que se registrará el movimiento del renglón es aquella que seleccionó (en el proceso [Artículos](https://ayudas.axoft.com/25ar/articulo_carp_st2)) como "control de stock", la otra unidad de medida la deberá ingresar en una ventana emergente que se desplegará automáticamente.
