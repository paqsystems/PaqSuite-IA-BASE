...
- Modulo: Stock
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_st/guia_correccmonetbiencamb_st/
...
Para aplicar corrección monetaria, siga estos pasos:
  ...
  1. Defina en la sección valorización de [Parámetros de Inventario](https://ayudas.axoft.com/25ar/parametrogeneral_st) la configuración relacionada a corrección monetaria. Debe seleccionar un criterio de valorización de precio promedio ponderado P.P.P (cierre mensual o cierre mensual con valor diario) y los siguientes parámetros específicos de corrección monetaria: 
     1. Próximo período de cierre.
     2. Índices de precios al consumidor.
     3. Tipo de cotización.  
Para más información, consulte la ayuda de [Parámetros generales de Inventario](https://ayudas.axoft.com/25ar/parametrogeneral_st).
  2. Seleccione los artículos a los que se les debe aplicar la corrección monetaria: puede realizarlo desde [Artículos](https://ayudas.axoft.com/25ar/articulo_carp_st) o [Actualización masiva de artículos](https://ayudas.axoft.com/25ar/actualizmasivartic_st), habilitando la opción Aplica corrección monetaria e indicando el origen del artículo (nacional o importado).  
...
Si fuese necesario ingresar o eliminar algún comprobante que afectó al último cierre definitivo siga los pasos que se especifican a continuación:
  ...
  * Por último, ejecute el [cierre por corrección monetaria](https://ayudas.axoft.com/25ar/correccmonetcierre_st).
