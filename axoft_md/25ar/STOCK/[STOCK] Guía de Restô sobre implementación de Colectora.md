# Guía de Restô sobre implementación de Colectora
...
- Modulo: Stock
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_st3/guia_colectora_st3/
...
Tenga en cuenta que sólo se pueden utilizar tomas de inventario generadas por el proceso _Toma de inventario_ (movimientos masivos).  


##### Puesta en marcha

  1. Defina las [Colectoras](?p=12473) que utilizará en el conteo de los artículos.
  ...
  3. Ingrese a la aplicación y complete los datos de conexión a su sistema Tango. 
     1. Código de colectora: definido en el proceso [Colectoras](?p=12473).
...
##### Detalle del circuito de conteo para toma de inventario
  ...
  2. Ejecute la acción 'Comenzar conteo' seleccionado como origen 'Aplicación Tango Colectora'. Puede seleccionar una colectora de la lista o bien dejar el campo vacío para que la toma esté disponible en todas las colectoras.
...
Si el artículo lleva partidas, se tendrá en cuenta la parametrización de modo de asignación de partidas en toma de inventario (manual o automático) para solicitar el número de la partida a la cual asignar la cantidad registrada, o puede utilizar la cámara o el láser para leer la partida en caso de tenerla disponible en código de barras.
     4. Podrá filtrar sólo artículos pendientes de contar, para agilizar el trabajo.
     5. Al finalizar el conteo, presione el botón para subir la información a su sistema Tango.
     6. Para continuar con el circuito, desde el sistema ingrese al proceso [Toma de inventario masiva](?p=10754), seleccione la acción 'Importar conteo de inventario', y elija el comprobante a procesar.
     7. Al seleccionar una toma de inventario que registre conteos desde la aplicación, se mostrará un detalle con los datos obtenidos de la colectora para confirmar y continuar con la toma.
     8. Al finalizar la actualización, se impactarán todas las cantidades ingresadas en la aplicación en la toma de inventario.
...
Para más información, consulte [Toma de inventario masiva](?p=10754).
...
##### Detalle del circuito de conteo de entrada
  ...
  3. Para agregar un nuevo artículo al conteo, presione el botón de código de barras. En la pantalla que se muestra podrá escanear el artículo que se desee o bien presionar en el botón de lupa y buscar el mismo a través de su descripción. Una vez que complete todos los datos obligatorios, presione el tilde para guardar los cambios.
  4. Repita el paso anterior para todos los artículos que desee incluir en el conteo de entrada.
  5. Al finalizar, presione el botón de subida.



A partir de este punto, el circuito continúa desde el ítem de Ingreso de stock masivo seleccionando la opción Registrar ingreso de stock.  
Para más información, consulte [Ingreso de stock masivo](http://ayudas.axoft.com/25ar/ingresostmasivo_st3).

##### Detalle del circuito de conteo de salida

  1. Ingrese al dispositivo en el que ya tiene instalado y configurado **Tango Colectora** y desde el menú principal seleccione la empresa y el depósito, luego presione "Salidas".
  2. Presione el botón "+" para crear un nuevo conteo de salida. Se solicitará una referencia para identificar dicho conteo.
  3. Para agregar un nuevo artículo al conteo, presione el botón de código de barras. En la pantalla que se muestra podrá escanear el artículo que se desee o bien presionar en el botón de lupa y buscar el mismo a través de su descripción. Una vez que complete todos los datos obligatorios, presione el tilde para guardar los cambios.
  4. Repita el paso anterior para todos los artículos que desee incluir en el conteo de salida.
  5. Al finalizar, presione el botón de subida.
...
Para más información, consulte [Egreso de stock masivo](http://ayudas.axoft.com/25ar/egresostmasivo_st3).
