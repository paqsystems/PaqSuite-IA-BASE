# Guía de Restô sobre formularios gráficos de stock
...
- Modulo: Stock
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_st3/guia_formgrafico_st3/
...
A continuación, se detallan los pasos para poder implementar formularios gráficos en Stock:
  ...
  * **Talonarios de Stock:** una vez configurado el formulario gráfico, ingrese a [Talonarios de Stock](?p=26071) y, en el talonario del tipo de comprobante, indique que utiliza formularios gráficos. A continuación seleccione el código de modelo de impresión gráfico.
...
No, es opcional y puede decidir utilizar el formulario gráfico en cualquier momento. Sólo debe tener un formulario gráfico definido, y en el proceso [Talonarios de Stock](?p=26071) indicar que utiliza formulario gráfico y relacionar ese formulario gráfico con el talonario.

**¿Si me arrepiento puedo dejar de utilizar formulario gráfico?**  
Si se arrepiente de usar un formulario gráfico, puede ir al proceso [Talonarios de Stock](?p=26071) y desactivar la opción Utiliza formulario gráfico.
