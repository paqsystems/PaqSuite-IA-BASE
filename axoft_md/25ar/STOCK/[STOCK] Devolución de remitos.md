...
- Modulo: Stock
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_st/guia_series_st/?p=15407/
...
Si el Remito se confeccionó sobre ordenes de compra, pueden darse las siguientes alternativas:
  ...
  * Si las ordenes no existen en el sistema (se eliminaron por el proceso [Depuración de Ordenes de Compra](https://ayudas.axoft.com/25ar/cuentcorrdepop_cp2)) no genera ninguna actualización sobre los pendientes de recepción.
