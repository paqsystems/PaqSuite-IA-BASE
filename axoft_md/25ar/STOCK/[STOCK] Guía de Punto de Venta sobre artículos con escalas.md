...
- Modulo: Stock
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_st2/guia_artescala_st2/
...
**Ingrese al proceso [Parámetros de Stock](https://ayudas.axoft.com/25ar/parametrogeneral_st2) y habilite la opción Lleva artículos con escalas.

**Longitud de agrupaciones  
**Ingrese a [Longitud de agrupaciones](https://ayudas.axoft.com/25ar/longitagrupacion_st2) y configure la cantidad de dígitos o longitud que tendrá el código base, el código de valor de escala 1 y el código de valor de escala 2 (si corresponde).
...
**Ingrese a [Definición de escalas](https://ayudas.axoft.com/25ar/longitagrupacion_st2/#escalas) para configurar las escalas a utilizar y los correspondientes valores para cada una de ellas.  
...
**Como último paso ingrese al proceso [Artículos con escalas](https://ayudas.axoft.com/25ar/articulo_carp_st2/#escalas) para crear el artículo base en función del que se generarán las especializaciones.
