...
- Modulo: Stock
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_st/guia_series_st/?p=17028/
...
Si el sistema está configurado para que Lleve doble unidad de medida desde [Parámetros de Stock](https://ayudas.axoft.com/25ar/parametrogeneral_st) y el tipo de comprobante de ajuste está configurado para que permita ajustar una unidad de stock, no se aplica el control entre las unidades de stock durante el ingreso de comprobantes.
