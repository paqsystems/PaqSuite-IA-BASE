...
- Modulo: Stock
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_st/guia_partidas_st/?p=17165/
...
Tipo de comprobante: identifica el tipo de movimiento de ingreso. Estará definido previamente en el proceso [Tipos de comprobante](https://ayudas.axoft.com/25ar/tipocomprobante_st) con un Tipo de Movimiento = 'E' (entradas de stock).
...
Pulsando la tecla _< F6> \- Alta de Artículos_ desde el campo Código, podrá agregar un nuevo artículo en los archivos. Se abrirá una pantalla igual a la del proceso [Artículos](https://ayudas.axoft.com/25ar/articulo_carp_st) para ingresar todos los datos correspondientes. Una vez finalizada la carga, pulse <F10> para confirmar el alta del artículo.
...
_El método más ágil de acceso consiste en:_
  ...
  * Ingresar el código base del artículo. Para más información, consulte el proceso [Artículos con escalas](https://ayudas.axoft.com/25ar/articulo_carp_st/#escalas).
...
Al pulsar las teclas <Alt+E> desde el campo Artículo será posible dar de alta un nuevo artículo con escalas, si es que se encuentra activado el parámetro Permite Alta de Artículos desde Procesos en [Perfiles de ingresos de stock](https://ayudas.axoft.com/25ar/perfilingreso_st).  
...
Si en [Perfiles de ingresos de stock](https://ayudas.axoft.com/25ar/perfilingreso_st) posee activado el parámetro Permite alta de valores de escalas al ingresar un valor de escala 1 o 2 inexistente, podrá darlo de alta desde este proceso para así continuar con el ingreso de comprobante sin salir del proceso.
...
##### Contenidos relacionados
  ...
  * [Video sobre perfiles y movimientos de stock](https://ayudas.axoft.com/25ar/videos/st_carp_vid/perfmovstock_st_vid/)
