...
- Modulo: Stock
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_st/guia_colectora_st/
...
##### Puesta en marcha
  ...
  1. Defina las [Colectoras](http://ayudas.axoft.com/25ar/colectora_st) que utilizará en el conteo de los artículos.
  ...
  3. Ingrese a la aplicación y complete los datos de conexión a su sistema Tango. 
     1. Código de colectora: definido en el proceso [Colectoras](http://ayudas.axoft.com/25ar/colectora_st).
...
Si el artículo lleva partidas, se tendrá en cuenta la parametrización de modo de asignación de partidas en toma de inventario (manual o automático) para solicitar el número de la partida a la cual asignar la cantidad registrada, o puede utilizar la cámara o el láser para leer la partida en caso de tenerla disponible en código de barras.
     ...
     7. Para continuar con el circuito, desde el sistema ingrese al proceso [Toma de inventario masiva](http://ayudas.axoft.com/25ar/ajusteinventariocolectora_st), seleccione la acción 'Importar conteo de inventario', y elija el comprobante a procesar.
...
Para más información, consulte [Toma de inventario masiva](http://ayudas.axoft.com/25ar/ajusteinventariocolectora_st).
...
Para más información, consulte [Ingreso de stock masivo](http://ayudas.axoft.com/25ar/ingresostmasivo_st), o bien, [Ingreso de remitos por Excel o Colectora](https://ayudas.axoft.com/25ar/ingresoexcelcolect_cp).
...
Para más información, consulte [Egreso de stock masivo](http://ayudas.axoft.com/25ar/egresostmasivo_st).

##### Contenidos relacionados

  * [Colectoras](https://ayudas.axoft.com/25ar/ayudas/st/archivos_carp_st/actualizacion_carp_st/colectora_st/)
