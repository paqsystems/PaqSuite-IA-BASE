...
- Modulo: Stock
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_st/guia_serpart_st/?p=17398/
...
Las series listadas en el sector derecho son las que están asociadas al artículo / depósito seleccionado en el sector izquierdo. En caso de no existir series para el artículo / depósito debe ingresarlas manualmente desde el proceso de [mantenimiento de series por artículo](?p=17183).
...
Dependiendo de la configuración de [Parámetros de Stock](https://ayudas.axoft.com/25ar/parametrogeneral_st), es posible limitar los egresos de artículos con series y partidas no relacionadas para mantener un mejor control del inventario.
