...
- Modulo: Compras
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_cp/guia_cuentacorriente_cp/?p=10269/
...
Tipo de terminal: seleccione el tipo de terminal POS con la que va a operar. Las opciones posibles son las siguientes: 'LaPos', 'Payway', 'Posnet', 'Clover' o 'Externo (Solo Tiendas)'.
...
Si el tipo de terminal es Payway o Clover, esta configuración debe realizarla manualmente ya que por una limitación de Payway y de Fiserv, respectivamente, esa información no puede ser recuperada de la terminal.
...
Si la terminal POS está configurada para trabajar en modo integrado, esta grilla se completa en forma automática en el momento de ejecutar el comando Importar datos del POS. Sólo deberá indicar el código equivalente en Tango para las tarjetas obtenidas desde las tablas internas de la terminal POS. Si el tipo de terminal es Payway o Clover, esta configuración debe realizarla manualmente ya que por una limitación de Payway y de Fiserv, respectivamente, esa información no puede ser recuperada de la terminal.  
Además, si la terminal POS está configurada para trabajar en modo integrado y el tipo de terminal es Payway o Clover, se debe ingresar en el código de tarjeta del POS la equivalencia correspondiente. Para más información, consulte las tablas de equivalencias en la [puesta en marcha de pagos con Payway](?p=14430/#puesta-en-marcha) o la [puesta en marcha de pagos con Clove](?p=16549/#puesta-en-marcha)r.
...
Número de serie: corresponde al número de serie de la terminal. Es requerido y solo está disponible si el tipo de terminal es Clover.

Forma de envío/impresión: permite configurar la forma de envío/impresión del cupón emitido para el comprador. Solo está disponible si el tipo de terminal es Clover. Los valores posibles de configuración son: 'Ninguna', 'Papel', 'Correo electrónico', 'SMS' y 'Selecciona vendedor en dispositivo'.

Puerto COM: indique el puerto COM de la PC en la cual estará conectado (no disponible para dispositivos Clover). Aunque el POS utilice un conector USB, indique el puerto COM que emula la conexión USB.  
...
##### Contenidos relacionados
  ...
  * [Guía de implementación sobre pagos QR con Posnet](https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_qrposnet_gv/)

  * [Guía sobre implementación de pagos con Clover](https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_clover_gv/)

  * [Guía sobre implementación de pagos con Payway](https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_gv/guia_payway_gv/)
  ...
  * [Video sobre integración con dispositivos de tarjeta](https://ayudas.axoft.com/25ar/videos/gral_carp_vid/integrdisptarjeta_gral_vid/)
