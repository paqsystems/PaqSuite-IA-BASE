...
- Modulo: Compras
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_cp/guia_cuentacorriente_cp/?p=8434/
...
Tipo de comprobante: seleccione el comprobante a ingresar, por defecto el sistema cuanta con tipos definidos: 'ANT' para anticipos, 'GAS' para gastos, 'OTR' para otros pagos, 'RTC' y 'RTV' para retenciones de compras y ventas respectivamente. Si lo desea puede agregar otros tipos de comprobantes utilizando el proceso [Tipos de comprobantes para IIBB](?p=8442).
