...
- Modulo: Compras
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_cp/guia_cuentacorriente_cp/?p=10363/

## Contenido

# Pasaje a histórico de cheques !

Este proceso pasa a histórico los cheques propios y de terceros, cuya fecha sea menor o igual a una fecha ingresada y además depurar el archivo histórico acelerando las consultas.

##### Datos solicitados

Tipos de cheques

De terceros y Propios: indique el tipo de cheques con los que va a trabajar en el proceso: cheques de terceros y/o los cheques propios.

Operaciones a realizar

Seleccione que operación desea realizar, puede realizar el pasaje a histórico y/o depurar los históricos.

Pasar a histórico: sólo pasarán a histórico los cheques cuyos comprobantes de referencia se encuentren en histórico. Es decir que si el comprobante de origen, aplicación y eventualmente de rechazo no pasaron a histórico, el cheque en cuestión tampoco pasará. Tenga en cuenta:
  ...
  * Si un cheque tiene estado anulado (porque el comprobante de origen fue revertido con un contraasiento), pasará a histórico siempre que los comprobantes que lo referenciaron (incluyendo el de reversión) también hayan pasado a histórico.Si está activo el [parámetro general](?p=10293) Asigna Subestados a los Cheques de Terceros, es posible seleccionar el rango de subestados de cheques aplicados y de cheques rechazados que se desea procesar. Se borrará la información del historial de cada uno de los cheques pasado a histórico y comprendidos en el rango indicado para su estado.
  * Si está activo el parámetro general Asigna subestados a los cheques de terceros, es posible seleccionar el rango de subestados de cheques aplicados y de cheques rechazados que se desea procesar. Se borrará la información del historial de cada uno de los cheques pasado a histórico y comprendidos en el rango indicado para su estado.



Fecha hasta: indique hasta que fecha desea pasar a histórico los cheques. Se considera la fecha del cheque para realizar la depuración.

Depurar histórico: permite borrar la información almacenada en el archivo histórico.

Fecha hasta: indique la fecha hasta la cual desea depurar los históricos. Por defecto viene configurado para conservar 2 años, pero es posible desactivar la opción, con lo cual eliminaría toda la información.

Seleccionador de cheques

Por medio del seleccionador puede aplicar otros filtros para determinar con mayor precisión los cheques que se desean pasar a históricos.  
Al finalizar el proceso tendrá la opción de generar una planilla Excel con el resultado de los cheques procesados ya sea que hayan pasado a histórico o que haya quedado pendientes. Esta planilla la encontrará en el sector de descargas.
