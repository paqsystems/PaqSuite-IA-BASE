...
- Modulo: Compras
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_cp/guia_integrcontabl_cp/?p=19368/

## Contenido

# Parametrización contable en Ventas - Modelos de asientos

Esta opción permite definir prototipos o modelos de asientos, que luego pueden ser asociados a los [Tipos de comprobantes](https://ayudas.axoft.com/25ar/tipocomprobparamcont_gv) o pueden ser asociados a los comprobantes desde el ingreso de los mismos.
...
El sistema habilita los tipos contables según el tipo de comprobante seleccionado y propone el modelo de asiento para el comprobante:
  ...
  * [Detalle](https://ayudas.axoft.com/25ar/modeloasientoparamcont_gv#detalle_modelo) del modelo
