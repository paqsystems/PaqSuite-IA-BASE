...
- Modulo: Compras
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_cp/guia_cuentacorriente_cp/?p=10330/
...
En el primer caso, se solicita el ingreso de los siguientes datos:
  ...
  * Código de [cuenta](?p=10235) bancaria emisora (cuenta corriente o cheques diferidos).
  * [Chequera](?p=10144).
  * Rango de números de cheques a imprimir de esa chequera.
  * Código de [modelo de impresión](?p=10934).
