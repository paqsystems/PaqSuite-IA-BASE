...
- Modulo: Compras
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_cp/guia_actualalicagipbsas_cp/?p=14619/
...
Para más información sobre este tema, consulte en el proceso [Talonarios](https://ayudas.axoft.com/25ar/talonario_cp2), las alternativas que se brindan al respecto y el comportamiento que provoca el talonario.

Talonario CPR: este campo permite asignar un talonario para Constancias provisionales de retención. La numeración e impresión dependen del talonario. Varias Constancias provisionales de retención pueden compartir un mismo talonario. Para más información sobre este tema, consulte en el proceso [Talonarios](https://ayudas.axoft.com/25ar/talonario_cp2).
...
Para implementar el circuito de Constancias Provisionales de retención establecido por la RG 2426/2008, siga los siguientes pasos:
  ...
  1. Ingrese a [Parámetros Retenciones](https://ayudas.axoft.com/25ar/paramgrales_cp2/#parametros-para-retenciones) para especificar, desde el ítem Edita Tipo de Retención (CPR/RET) que muestre la ventana con el detalle de las Retenciones y/o Constancias provisionales de retención generadas en los procesos [Ingreso de Facturas](https://ayudas.axoft.com/25ar/factura1_carp_cp2)[ y/o Pagos.](https://ayudas.axoft.com/25ar/ccorringrpago_cp2) Los valores posibles son ‘E’: Edita, ‘M’: Muestra y ‘O’: Oculta. El valor defecto es Oculta.
  ...
  3. Desde el proceso [Actualización de Retenciones](https://ayudas.axoft.com/25ar/actualretencion_cp2) ingrese en cada uno de los códigos de retención para asignar el talonario de Constancia Provisional de Retención, si no se asigna ninguno siempre se generar una retención.
...
##### Contenidos relacionados
  ...
  * [Clasificación para retenciones](https://ayudas.axoft.com/25ar/ayudas/cp2/archivos_carp_cp2/actualizacion_carp_cp2/clasifretenc_cp2/)

  * [Guía sobre bases de cálculo para retenciones tipo Otras](https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_cp2/guia_calcretotras_cp2/)
