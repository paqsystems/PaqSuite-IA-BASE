...
- Modulo: Compras
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_cp2/guia_comprobajustint_cp2/
...
El asistente para [Generación de comprobantes de ajuste](https://ayudas.axoft.com/25ar/genercomprobajuste_cp2) le permite cancelar el saldo de comprobantes que hayan quedado pendientes por variaciones en el tipo de cambio de la moneda extranjera o por redondeos no aplicados en el momento del pago.  
...
Previo a poder realizar los comprobantes de ajustes internos por diferencia de cambio y por cancelación de saldos, debe verificar que tenga configurados los siguientes puntos:
  ...
  2. Parámetros de compras: dentro de la solapa Comprobantes de ajustes de la opción [Comprobantes](https://ayudas.axoft.com/25ar/paramgrales_cp2/#parametros-para-comprobantes), indique los tipos de comprobante a utilizar para la generación de débitos y créditos de cancelaciones de saldo y diferencias de cambio.
