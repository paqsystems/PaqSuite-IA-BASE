...
- Modulo: Tesorería
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_sb/guia_integrcontabl_sb/?p=14666/
...
De acuerdo a la configuración realizada en [parámetros contables](?p=11964) del módulo Procesos generales, y estando en el alta de un nuevo proveedor, el sistema le preguntará si desea realizar la parametrización contable del proveedor.
...
La configuración se divide en dos solapas: [Cuentas](https://ayudas.axoft.com/25ar/paramcontproveed_cp2#cuentas) y [Modelos de asientos](https://ayudas.axoft.com/25ar/paramcontproveed_cp2#modelasientos).
