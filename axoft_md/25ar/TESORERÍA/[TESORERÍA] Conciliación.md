...
- Modulo: Tesorería
- Categoria: Guía
- URL: https://ayudas.axoft.com/25ar/documentos/guias/guias_carp_sb/guia_tarjetas_sb/guia_pm_tajcredeb_sb/?p=10169/
...
Saldo final del extracto: puede ingresar el saldo final que figura en el extracto, para verificar a que valor se debe llegar luego de la conciliación. En caso de que la cuenta esté asociada a TangoBanking, puede obtener este valor desde la entidad bancaria presionando el botón "Obtener saldo a fecha".
...
_En el caso de aquellos registros del extracto electrónico que deben quedar como conceptos pendientes de registrar, el sistema tendrá en cuenta lo configurado en [Definición de formato de extracto electrónico](?p=10209) en la solapa Pendientes de registrar. También puede marcar manualmente un movimiento del extracto como pendiente de registrar desde la columna "Conciliado", seleccionando el valor 'Pendiente'. En ese momento se abrirá una ventana en donde deberá indicar a qué concepto se relaciona y si se quiere agregar a la definición del extracto para que en las próximas conciliaciones ya lo tengan en cuenta. En ese caso deberá indicar la equivalencia y el contenido por el cual se comparará para incorporarlo como pendiente de registrar.
...
##### Contenidos relacionados
  ...
  * [Videos sobre conciliación bancaria automática](https://ayudas.axoft.com/25ar/videos/sb_carp_vid/concilbancautom_sb_vid/)
