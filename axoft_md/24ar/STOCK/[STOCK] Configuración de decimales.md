...
- Modulo: Stock
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_st/guia_unidadmedida_st/?p=9150/
...
Asigne la cantidad de decimales en cantidades de artículos (Stock) y en precios de artículos (excepto listas de precios de Ventas).

##### Módulo Sueldos

Indique la configuración de decimales para las cantidades y valorizaciones de liquidación, importes del módulo Sueldos e importes de liquidación.
