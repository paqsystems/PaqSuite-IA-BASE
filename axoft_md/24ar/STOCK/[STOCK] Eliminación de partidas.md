...
- Modulo: Stock
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_st/guia_partidas_st/?p=17092/
...
Se trata de un proceso inverso al de [Asignación de Partidas](https://ayudas.axoft.com/24ar/asignacpartidartic_st). De esta manera, se podrá desactivar el parámetro Lleva Partidas para un artículo que tiene saldos (mayores a cero) y movimientos de partidas generados.
...
Esta modificación no podrá realizarse desde el proceso [Artículos](https://ayudas.axoft.com/24ar/articulo_carp_st).
