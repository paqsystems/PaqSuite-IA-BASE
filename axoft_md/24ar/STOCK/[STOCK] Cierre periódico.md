...
- Modulo: Stock
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_st/guia_correccmonetbiencamb_st/?p=17233/
...
El proceso generará un informe con el PPP calculado para cada uno de los artículos. Este podrá ser consultado posteriormente desde el proceso [Actualización individual de PPP](https://ayudas.axoft.com/24ar/pppactualizacionindividual_st).  
Finalmente, actualizará la fecha de último cierre, que puede visualizarse desde el proceso [Parámetros de Stock](https://ayudas.axoft.com/24ar/parametrogeneral_st). Esta será la fecha de control que utilizará en los ingresos y anulación de comprobantes.  
...
Para más información sobre el cálculo de PPP, consulte el proceso [Precio Promedio Ponderado](https://ayudas.axoft.com/24ar/preciopromedioponderado_st).
