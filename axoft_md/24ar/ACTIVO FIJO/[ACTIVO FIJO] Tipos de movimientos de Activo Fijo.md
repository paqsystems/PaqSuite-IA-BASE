...
- Modulo: Activo Fijo
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_afa/guia_administracionbienes/?p=5954/
...
Edita asiento: indique se es posible cambiar el modelo de asientos en la [Registración de movimientos](?p=6749). Por defecto, este parámetro está deshabilitado y activado. Si se activa el parámetro Genera asiento usted puede desactivarlo.
