...
- Modulo: Activo Fijo
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_afa/guia_administracionbienes/?p=5956/
...
Número de orden: este número servirá para mostrar los tipos de valoración desde la [Registración de movimientos](?p=6749) o desde las distintas consultas. Su ingreso es obligatorio y podrá tomar los valores entre 1 a 3.
...
Indice de ajuste: seleccione el indice defecto que se utilizará para el proceso [Ajuste por inflación de Activo Fijo](?p=5900). Este ingreso es opcional.
