...
- Modulo: Sueldos
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_sua/guia_puestamarcha_sua/?p=13196/
...
Código OS [axvar variable=dgi_arca]: indique la codificación de la obra social, según [axvar variable=dgi_arca]. Este dato es requerido por el proceso [Generación a SICOSS - Declaración en Línea](?p=13100)
...
Los datos que mencionamos a continuación, son referenciables desde las variables para [fórmulas de liquidación](?p=13092).
...
Los porcentajes e importes de retención y contribución son utilizables desde las variables para [fórmulas de liquidación](?p=13092).
...
Para acceder a los beneficios del plan, la suma de retención y contribución deben cubrir el importe del plan indicado. Esto debe considerarse en la [fórmula de liquidación](?p=13092) del concepto.
