...
- Modulo: Sueldos
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_sua/guia_impganancias_sua/?p=13241/
...
Código de modelo de asiento: si genera los asientos contables de las liquidaciones, especifique el [modelo de asiento](?p=13179) a utilizar.

Formato de borrador, recibo y Libroley: es posible indicar un formato de impresión diferente para cada tipo de liquidación, según el modelo de impresión configurado en [Parámetros de Sueldos](?p=13208) (RPT o TYP).

##### Contenidos relacionados

  * [Video sobre nuevo piso IIGG (2023)](https://ayudas.axoft.com/24ar/videos/sua_carp_vid/nuevopisoganancia_sua_vid/)
