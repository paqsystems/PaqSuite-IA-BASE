...
- Modulo: Sueldos
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_sua/guia_siap-sicoss_sua/

## Contenido

# Guía de implementación de días para SIAp - SICOSS

Sueldos cuenta con un proceso de generación de archivos ASCII que permite exportar información para ser utilizada en el sistema SICOSS de AFIP, este proceso se encuentra en [Generación al SIAp - SICOSS](?p=13100).
