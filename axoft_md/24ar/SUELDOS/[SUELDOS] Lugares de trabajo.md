...
- Modulo: Sueldos
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_sua/guia_puestamarcha_sua/?p=13174/
...
Código de zona: referencia opcional a una _Zona DGI_ , de utilidad para la [Generación al SIAp - SICOSS](?p=13100) La provincia de la ubicación del lugar de trabajo debe corresponder con la provincia de la zona referenciada.
...
Esta solapa reúne los datos para el aplicativo _MiSimplificación_.
...
Tipo de domicilio: indica si se trata de un domicilio de ‘Explotación’, ‘Ambulante’, 'Del trabajador', `Terceros ' o `Exterior`, este dato se utiliza en el archivo Domicilios de explotación.

La información para el aplicativo _MiSimplificación_ se completa con el ingreso de los siguientes datos: Fecha de presentación, Actividad y Localidad DGI.

Si usted cambia algún dato de esta ficha y el Estado de la presentación es 'Informado por alta', el sistema exhibe un mensaje solicitando su confirmación para informar la modificación realizada al aplicativo _MiSimplificación_. Por defecto, se propone informar los cambios. Si usted confirma esta acción, el Estado de la presentación pasa a 'No informado'.
