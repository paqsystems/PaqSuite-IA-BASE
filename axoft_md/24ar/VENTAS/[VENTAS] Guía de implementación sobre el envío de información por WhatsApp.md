...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_constprovisretencion_gv/?p=10551/
...
El cuarto dato necesario es el token de acceso. Si bien en esta página puede generar uno, le sugerimos no utilizarlo ya que tienen una vigencia de solo 24 horas por lo que deberá volver a esta sección para generarlo todos los días. En la sección Obtención del token para la API de WhatsApp le explicaremos cómo obtener un token de acceso sin fecha de caducidad.  
...
Para más información, consulte en [https://developers.facebook.com/docs/whatsapp/cloud-api/reference/registrati](https://developers.facebook.com/docs/whatsapp/cloud-api/reference/registration/)
...
Ingrese a Procesos generales | Tablas generales | Parámetros de WhatsApp y complete los campos requeridos en la solapa Principal.  
Recuerde que le sugerimos copiar esta información en los puntos Configuración de WhatsApp y Obtención del token para la API de WhatsApp.
  ...
  * Identificador del número telefónico
...
##### Contenidos relacionados
  ...
  * [Parámetros de WhatsApp](https://ayudas.axoft.com/24ar/ayudas/gla/tablasgrales_carp_gla/whatsapp_gla/)
