...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_pedidos_gv/?p=17119/
...
Habilite el uso de doble unidad de medida desde [Parámetros de Stock](https://ayudas.axoft.com/24ar/parametrogeneral_st). A partir de esta configuración podrá definir artículos con esta funcionalidad

Ingrese al proceso [Artículos](https://ayudas.axoft.com/24ar/articulo_carp_st) y habilite el parámetro Lleva doble unidad de medida en el artículo.
...
En los comprobantes generados en el módulo Stock la unidad de medida en la que se registrará el movimiento del renglón es aquella que seleccionó (en el proceso [Artículos](https://ayudas.axoft.com/24ar/articulo_carp_st)) como "control de stock", la otra unidad de medida la deberá ingresar en una ventana emergente que se desplegará automáticamente.
...
##### Contenidos relacionados
  ...
  * [Guía sobre Unidad de Medida](https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_st/guia_unidadmedida_st/)
