...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv2/guia_constprovisretencion_gv2/
...
Desde el proceso [Códigos de retención](https://ayudas.axoft.com/24ar/codigoretenc_gv2), disponible desde Archivos | Actualizaciones, usted puede agregar, consultar, listar y modificar los códigos de retención.  
Este código le permitirá ingresar, desde el proceso [Cobranzas](https://ayudas.axoft.com/24ar/ingresocobranza_gv2) o durante la [Modificación de comprobantes](https://ayudas.axoft.com/24ar/modifcomprobante_gv2) las [Constancias provisionales de retención](https://ayudas.axoft.com/24ar/constprovisretencion_gv2) implementadas por la Resolución General 2426/2008.
