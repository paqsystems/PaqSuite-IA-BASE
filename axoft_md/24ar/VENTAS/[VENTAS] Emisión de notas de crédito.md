...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_comprobelectr_gv/guia_dc_comprobelectr_gv/?p=19289/
...
Los distintos tipos de notas de crédito son definidos mediante el proceso [Tipos de comprobante](https://ayudas.axoft.com/24ar/tipocomprobante_gv). En este proceso se indica en qué estadísticas de ventas interviene cada tipo de comprobante, si afecta al stock, si registra una diferencia de cambio, si registra importes de impuestos o interviene en el IVA Ventas.
...
A través de este proceso se confeccionan además, notas de crédito por diferencia de cambio en forma automática o manual, definiendo en el proceso [Tipos de comprobante](https://ayudas.axoft.com/24ar/tipocomprobante_gv) un código de comprobante que lo contemple.  
...
El movimiento de fondos o valores generado a través de este proceso, únicamente puede anularse en forma automática en el caso de anular el comprobante, a través del proceso [Anulación de comprobantes](https://ayudas.axoft.com/24ar/anulcomprob_gv).  
...
El sistema prevé dos maneras de efectuar esta imputación:
  ...
  * Aplicando la nota de crédito a uno o más comprobantes después de haber sido emitida, a través del proceso [Imputación de comprobantes](https://ayudas.axoft.com/24ar/imputcomprobante_gv).
...
##### Contenido dependiente
  ...
  * [Imputación contable](https://ayudas.axoft.com/24ar/ayudas/gv/procesofacturacion_gv/pos_gv/emisioncomprobantes_posgv/emisionc_gv/imputcontnc_gv/)
  * [Devolución de kits variables](https://ayudas.axoft.com/24ar/ayudas/gv/procesofacturacion_gv/pos_gv/emisioncomprobantes_posgv/emisionc_gv/devolucionkitsvariables_gv/)
