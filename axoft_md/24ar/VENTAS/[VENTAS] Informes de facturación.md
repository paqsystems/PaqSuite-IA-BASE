...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_comprobelectr_gv/guia_dc_comprobelectr_gv/?p=21546/
...
Si emite el informe por tipo de impuesto debe indicar si lista por código de impuesto (véase [Alícuotas](https://ayudas.axoft.com/24ar/alicuota_gv)) o por [Percepciones definibles](https://ayudas.axoft.com/24ar/percepcdefin_gv), puede indicar (opcionalmente) un código de provincias. Si indica una provincia, se incluirán en el listado para las alícuotas correspondientes a percepción de ingresos brutos ('51' a '80'), sólo aquellas que correspondan a la provincia elegida. Esta opción es de utilidad para emitir el informe de percepciones de ingresos brutos por jurisdicción. 
...
Notas de débito en general: en este caso se emite un listado de todos los comprobantes definidos como débito en el proceso [Tipos de comprobante](https://ayudas.axoft.com/24ar/tipocomprobante_gv).
