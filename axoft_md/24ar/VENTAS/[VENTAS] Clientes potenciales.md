...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gla/guia_alicuotiibbsantafe_gv3/?p=19235/
...
Este tipo de clientes se utiliza únicamente en los procesos relacionados con [Cotizaciones](https://ayudas.axoft.com/24ar/cotizaciones_carp_gv).  
...
**< F3> \- Próximo cliente  
**Esta función está disponible sólo si se encuentra habilitado el parámetro Codificación automática de clientes potenciales en la solapa Clientes del proceso [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes), y se completa utilizando el valor ingresado en el próximo código de cliente.
...
Si elige esta modalidad, al ingresar un nuevo cliente potencial, se genera automáticamente el código a asignar (de acuerdo a lo ingresado en el proceso [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes) en el campo Próximo Nro. de la ventana Clientes Potenciales). En este caso, el código generado no es editable.  
...
Condición de venta: este campo es obligatorio. Ingrese el código de [condición de venta](https://ayudas.axoft.com/24ar/condicionventa_gv) asociado al cliente potencial.  
...
<F8> \- Actual. s/ padrones:

Pulse <F8> \- Asignación de alícuota de I.B. según padrones de Rentas de ARBA (provincia Bs.As.), de AGIP (ciudad de Bs.As.) y de API (provincia de Santa Fe) para consultar los padrones mencionados y asignar en forma automática la alícuota de percepción que se le debe aplicar al cliente potencial.  
...
Si el cliente liquida percepciones definibles es necesario asociarle un código previamente definido en el proceso [Clasificación percepciones definibles](https://ayudas.axoft.com/24ar/clasifpercepdefin_gv).  
...
Indique el formulario (archivo .Typ) a utilizar para la impresión de [Facturas](https://ayudas.axoft.com/24ar/procesofacturacion_gv); [Notas de crédito](https://ayudas.axoft.com/24ar/emisionc_gv) y/o [Notas de débito](https://ayudas.axoft.com/24ar/emisionnd_gv), independientemente que el comprobante sea electrónico o no electrónico, de exportación o de uso en el mercado local.  
...
Para mayor información sobre cómo definir el valor 'CL' a fines de generar el asiento contable con el total del comprobante en la cuenta del cliente, consulte el ítem [Tipos de asiento](https://ayudas.axoft.com/24ar/tipoasiento_gv).
