...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_fechalternat_gv/?p=18378/

## Contenido

# Generar una factura con fechas alternativas de vencimiento

Indique que el comprobante a generar es de cuenta corriente. Para más información consulte [Cobro en cuenta corriente](https://ayudas.axoft.com/24ar/cobrarcuentacorriente_posgv).

Seleccione una [condición de venta](https://ayudas.axoft.com/24ar/condicionventa_gv) que tenga definidas fechas alternativas de vencimiento para el cobro de sus cuotas.

Para más información consulte la [guía de implementación de fechas alternativas de vencimiento](?p=26634).
