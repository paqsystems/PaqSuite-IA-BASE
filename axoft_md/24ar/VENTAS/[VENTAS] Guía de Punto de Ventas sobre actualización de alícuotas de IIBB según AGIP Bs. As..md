...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv2/guia_alicuotiibb_gv2/
...
A continuación se detallan los pasos a seguir para la asignación de códigos de percepción de ingresos brutos en base al padrón de Rentas.
  ...
  1. Decida como prefiere implementar el impuesto a los ingresos brutos en el sistema. Para más información consulte [¿Cómo me conviene implementar las percepciones de ingresos brutos?](https://ayudas.axoft.com/24ar/guia_pm1_alicuotiibb_gv2)
  2. Ingrese al proceso [Alícuotas](https://ayudas.axoft.com/24ar/alicuota_gv2) o [Percepciones definibles](https://ayudas.axoft.com/24ar/percepcdefin_gv2) según lo definido en el punto anterior y complete para cada percepción el campo Grupo AGIP Para más información sobre este campo consulte [Consideraciones sobre el campo Grupo AGIP](https://ayudas.axoft.com/24ar/guia_pm2_alicuotiibb_gv2).  
...
Tenga en cuenta que también puede clasificar a los clientes desde los procesos [Clientes](https://ayudas.axoft.com/24ar/clientes_carp_gv2) y [Clientes ocasionales](?p=19271#clientesocasionales). Seleccione "Actualizar según padrones" para asignar en forma automática el código de percepción de ingresos brutos que le corresponda de acuerdo al padrón.  
...
Usted puede implementar las percepciones de ingresos brutos mediante alguna de las siguientes opciones:
  ...
  * [Alícuotas](https://ayudas.axoft.com/24ar/alicuota_gv2): es la forma básica de definir percepciones de ingresos brutos. Aunque cubre la mayor parte de las necesidades de este impuesto posee algunas limitaciones con respecto a las percepciones definibles.
...
Configure la provincia asociada al padrón de régimen general, para más información consulte el proceso [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv2/#parametros-para-impuestos).
