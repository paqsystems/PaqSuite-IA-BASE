...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_comprobelectr_gv/guia_dc_comprobelectr_gv/?p=19290/
...
Los distintos tipos de notas de débito están definidos en el proceso [Tipos de comprobante](https://ayudas.axoft.com/24ar/tipocomprobante_gv). En este proceso se indica en qué estadísticas de ventas interviene cada tipo de comprobante, si afecta al stock, si registra una diferencia de cambio, si registra importes de impuestos o interviene en el IVA Ventas.

RG 3572 - Tipo de Operación: si está activo el [parámetro general](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-comprobantes) RG 3572 - Sujetos vinculados y el [cliente](https://ayudas.axoft.com/24ar/clientes_carp_gv) está definido como 'Empresa vinculada', los comprobantes que intervengan en el IVA Ventas tendrán por defecto el Tipo de operación del cliente. Este dato es editable.  
...
Ingrese un [tipo de comprobante](https://ayudas.axoft.com/24ar/tipocomprobante_gv) que tenga activo el parámetro registra intereses por mora.  
...
En el caso de no realizar referencia a ningún comprobante, puede hacerlo posteriormente en el proceso [Imputación de comprobantes](https://ayudas.axoft.com/24ar/imputcomprobante_gv), generando el historial de interés por mora en este momento.
...
Si el talonario elegido es electrónico y no está asignado el Código AFIP a cada una de las [alícuotas](https://ayudas.axoft.com/24ar/alicuota_gv) y [percepciones definibles](https://ayudas.axoft.com/24ar/percepcdefin_gv), se exhibirá un mensaje de atención avisando de la imposibilidad de generar la diferencia de cambio automática.  
...
Ingrese un [tipo de comprobante](https://ayudas.axoft.com/24ar/tipocomprobante_gv) que tenga activo el parámetro descuento / recargo por cobro en fechas alternativas.  
...
La clasificación de la información para SIAp - IVA se comporta de la misma manera que la detallada en el proceso [Facturas](https://ayudas.axoft.com/24ar/facturas_gv).  
...
El ingreso de renglones del comprobante es similar al descripto para el proceso [Facturas](https://ayudas.axoft.com/24ar/facturas_gv).  
...
Para que una nota de débito esté en condiciones de ser pasada a archivo histórico, es necesario que sea contado o esté aplicada o imputada a uno o varios comprobantes.
  ...
  * Aplicando la nota de débito a uno o más comprobantes después de haberla emitido, a través del proceso [Imputación de comprobantes](https://ayudas.axoft.com/24ar/imputcomprobante_gv).
...
##### Contenido dependiente
  ...
  * [Imputación contable](https://ayudas.axoft.com/24ar/ayudas/gv/procesofacturacion_gv/pos_gv/emisioncomprobantes_posgv/emisionnd_gv/impcontfactpvta_gv/)
