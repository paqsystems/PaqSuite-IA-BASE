...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_percepdefin_gv/
...
Desde el [Facturador](https://ayudas.axoft.com/24ar/pos_gv) puede consultar las percepciones calculadas en el comprobante ingresando desde la solapa Pagos a la opción Más acciones y luego al ítem Impuestos o también presionando <F6>.
...
**Usted puede implementar las percepciones de ingresos brutos mediante alguna de las siguientes opciones:
  ...
  * [Alícuotas](https://ayudas.axoft.com/24ar/alicuota_gv): es la forma básica de definir percepciones. Aunque cubre la mayor parte de las necesidades posee algunas limitaciones con respecto a las percepciones definibles.
...
Recuerde que si necesita utilizar el concepto de clasificación para [percepciones definibles](https://ayudas.axoft.com/24ar/percepcdefin_gv) debe asignarla a cada uno de los clientes, artículos y bases de cálculo que así lo requieran.
...
Una vez definida las percepciones, debe ingresar a los procesos [Actualización de clientes](https://ayudas.axoft.com/24ar/clientes_carp_gv) y [Actualización de clientes potenciales](https://ayudas.axoft.com/24ar/clientepotencial_gv) para asignarle el código de percepción definible que se le debe liquidar dentro de la pantalla Características de Facturación (bajo el título "Percepciones definibles").  
...
Si se encuentra habilitada la opción Edita percepciones definibles en la solapa Impuestos del proceso [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes) será posible agregar o eliminar los códigos de percepción parametrizados en el cliente o cambiar la alícuota asignada. Estas modificaciones pueden realizarse desde los procesos de [Facturación](https://ayudas.axoft.com/24ar/facturas_gv), [Notas de crédito](https://ayudas.axoft.com/24ar/emisionc_gv) y [Notas de débito](https://ayudas.axoft.com/24ar/emisionnd_gv).
...
En caso de querer desglosar contablemente los importes correspondientes a percepciones definidas, ingrese al proceso [Tipos de asiento](https://ayudas.axoft.com/24ar/tipoasiento_gv) y agregue nuevos renglones para detallar las cuentas a imputar. Para cada una de ellas indique el código de percepción y la alícuota correspondiente.
...
##### Contenido dependiente
  ...
  * [Esquema de la lógica de percepciones definibles](https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_percepdefin_gv/guia_percdef_introduccion_gv/)



##### Contenidos relacionados

  * [Clasificación de percepciones](https://ayudas.axoft.com/24ar/ayudas/gv/archivos_carp_gv/actualizacion_carp_gv/clasifpercepdefin_gv/)

  * [Generación de archivo ASCII para percepciones definibles (Ventas)](https://ayudas.axoft.com/24ar/ayudas/gv/procperiodico_carp_gv/percepdefin_carp_gv/generarchasciipercepdefin_gv/)
