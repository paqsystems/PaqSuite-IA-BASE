...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_fechalternat_gv/?p=21557/
...
Puede utilizar el [buscador de variables de reemplazo](https://ayudas.axoft.com/24ar/variables_archive) para localizar aquella que se ajusta a sus necesidades.
...
Para ello, sugerimos realizar los siguientes pasos:
  ...
  1. Desde la solapa Comprobantes electrónicos del proceso [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes) defina el idioma habitual de los comprobantes electrónicos de exportación que usted emita.
  2. Desde el proceso [Clientes](https://ayudas.axoft.com/24ar/clientes_carp_gv) y para los clientes a enviar comprobantes en otro idioma, seleccione: inglés o portugués como idioma de sus comprobantes e indique el formulario a utilizar.
  3. Desde el proceso [Actualización individual de artículos por cliente](https://ayudas.axoft.com/24ar/actualizindivartcliente_gv) ingrese el sinónimo (expresado en el idioma del cliente).
