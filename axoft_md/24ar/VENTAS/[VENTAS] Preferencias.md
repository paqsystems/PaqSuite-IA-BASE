...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_pedidos_gv/?p=18516/
...
(Tipo: [por empresa](https://ayudas.axoft.com/24ar/tiipospreferencias_posgv))
...
(Tipo: [por usuario](https://ayudas.axoft.com/24ar/tiipospreferencias_posgv))
...
(Tipo: [por terminal](https://ayudas.axoft.com/24ar/tiipospreferencias_posgv))
...
(Tipo: [por usuario](https://ayudas.axoft.com/24ar/tiipospreferencias_posgvç))
...
Se indica si la terminal tiene conectada una terminal de compras con tarjeta de crédito, como por ejemplo las terminales LaPos, Posnet o Payway (marcas aceptadas por el Facturador).  
(Tipo: por [terminal](https://ayudas.axoft.com/24ar/tiipospreferencias_posgv))
...
Para más informacion vea la ayuda para el proceso [Precios y saldos de stock](https://ayudas.axoft.com/24ar/consprecsaldostock_carp_posgv).  
(Tipo: por [empresa](https://ayudas.axoft.com/24ar/tiipospreferencias_posgv))
...
(Tipo: por [termina](https://ayudas.axoft.com/24ar/tiipospreferencias_posgv)l)
...
Se listan a modo informativo, todas las preferencias de [tipo usuario](https://ayudas.axoft.com/24ar/tiipospreferencias_posgv), involucradas en los procesos establecer, restaurar y reiniciar por defecto.
