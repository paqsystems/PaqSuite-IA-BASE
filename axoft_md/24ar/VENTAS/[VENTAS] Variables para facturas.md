...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_caea_gv/?p=29067/
...
@TJ| Datos de tarjetas| 20| Descripción de la tarjeta (Resolución 3766 para cupones de  
tarjetas)  
...
comprobante en la zona de iteraciones. No hace falta repetir la variable cada veinte caracteres. Al ubicarse en la zona de iteraciones automáticamente imprimirá el texto y al llegar al  
