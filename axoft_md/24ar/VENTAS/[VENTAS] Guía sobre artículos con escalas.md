...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_pedidos_gv/?p=17101/
...
**Ingrese al proceso [Parámetros de Stock](https://ayudas.axoft.com/24ar/parametrogeneral_st) y habilite la opción Lleva artículos con escalas.

**Longitud de agrupaciones  
**Ingrese a [Longitud de agrupaciones](https://ayudas.axoft.com/24ar/longitagrupacion_st) y configure la cantidad de dígitos o longitud que tendrá el código base, el código de valor de escala 1 y el código de valor de escala 2 (si corresponde).
