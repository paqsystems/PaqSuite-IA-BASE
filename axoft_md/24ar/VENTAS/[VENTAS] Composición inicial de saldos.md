...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_cuentcorr_gv/?p=21159/
...
Los comprobantes que se ingresan a través de este proceso son:
  ...
  * Notas de crédito y Notas de débito: es necesario que se definan previamente, a través del proceso [Tipos de comprobante](https://ayudas.axoft.com/24ar/tipocomprobante_gv), aquellos tipos a utilizar. Los códigos que correspondan a estos tipos de comprobante serán los definidos por usted.
...
Los pasos a seguir son los siguientes:
  ...
  * [Ingrese la información en la planilla](https://ayudas.axoft.com/24ar/ingrdatplancompsaldo_gv) de Excel y grábela.
  * Desde el proceso [Composición inicial de saldos](https://ayudas.axoft.com/24ar/compinicialsaldo_gv), importe los datos desde Excel.
  * Al finalizar la importación, el sistema exhibirá el [Reporte de resultados](https://ayudas.axoft.com/24ar/reportrestimpcompsaldo_gv).
