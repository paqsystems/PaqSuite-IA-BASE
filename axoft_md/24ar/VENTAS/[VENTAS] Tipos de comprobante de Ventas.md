...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_cuentcorr_gv/?p=19573/
...
Para más información sobre tipos de asiento, consulte el proceso [Tipos de asiento](https://ayudas.axoft.com/24ar/tipoasiento_gv). En caso de haber configurado que integra con Contabilidad, luego de generar el alta del tipo de comprobante, el sistema lo guiará para acceder a la parametrización contable de [Tipos de comprobantes](https://ayudas.axoft.com/24ar/tipocomprobparamcont_gv).
