...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv/guia_constprovisretencion_gv/?p=21508/
...
El informe puede ser emitido en moneda corriente, en moneda extranjera (con cotización de origen o a ingresar) o en moneda cláusula. Si se emite en moneda cláusula, la información a imprimir puede estar expresada en moneda 'Corriente' o 'Extranjera', según lo parametrizado en el proceso [Clientes](https://ayudas.axoft.com/24ar/clientes_carp_gv).  
...
Consideraciones particulares para esta opción...
  ...
  * Sólo se incluirán aquellos clientes con dirección de correo electrónico ingresada en el proceso [Clientes](https://ayudas.axoft.com/24ar/clientes_carp_gv).
...
Si se emite en moneda cláusula, la información a imprimir puede estar expresada en moneda 'Corriente' o 'Extranjera', según lo parametrizado en el proceso [Clientes](https://ayudas.axoft.com/24ar/clientes_carp_gv).  
