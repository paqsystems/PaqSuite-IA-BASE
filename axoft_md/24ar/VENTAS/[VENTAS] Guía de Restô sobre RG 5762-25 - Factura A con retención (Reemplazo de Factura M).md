# Guía de Restô sobre RG 5762/25 - Factura A con retención (Reemplazo de Factura M)
...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gv3/guia_rg5762_gv3/
...
Para más información sobre definición de talonarios, consulte la ayuda de [Definición de talonarios Restô](?p=25001).  
Para más información sobre configuración de formularios de comprobantes de ventas, consulta la ayuda de [Talonarios de Ventas Restô](?p=22758).  
