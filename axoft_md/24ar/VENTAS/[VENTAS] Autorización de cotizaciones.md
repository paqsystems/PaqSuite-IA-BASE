...
- Modulo: Ventas
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gla/guia_alicuotiibbsantafe_gv3/?p=19216/
...
Sólo es posible acceder a este proceso si está activo el [Parámetro de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes) Autoriza cotizaciones. Sus campos son los mismos que los presentados en la ventana de [Generación / Modificación de cotizaciones](https://ayudas.axoft.com/24ar/genermodificotizacion_gv).
...
Este proceso actúa como una consulta general de cotizaciones. Ningún campo es editable, sólo puede cambiar el estado de la cotización y las clasificaciones adicionales, si están activas en la solapa Comprobantes de [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes).
...
Cuando una cotización cambia su estado (pasando de 'Ingresada' a 'Autorizada' o viceversa), se registran los datos de la operación, los que pueden consultarse desde el proceso [Consulta de cotizaciones](https://ayudas.axoft.com/24ar/consultacotiz_gv).
...
Dependiendo de los permisos y perfil de cotizaciones con los que acceda, puede autorizar:
  ...
  * Las cotizaciones pertenecientes a un grupo de usuarios configurados desde la opción [Permisos para cotizaciones](https://ayudas.axoft.com/24ar/permcotizacion_gv)
