...
- Modulo: Compras
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_cp/guia_integrcontabl_cp/?p=14664/

## Contenido

# Parametrización contable en Compras - Modelos de asientos

Esta opción permite definir prototipos o modelos de asientos, que luego pueden ser asociados a los [Tipos de comprobantes](https://ayudas.axoft.com/24ar/paramcontipocomprob_cp2) o pueden ser asociados a los comprobantes desde el ingreso de los mismos.
...
Compras divide los datos de un modelo de asiento en dos solapas: [Principal](https://ayudas.axoft.com/24ar/paramcontmodasiento_cp2#principal) y [Cuentas contables](https://ayudas.axoft.com/24ar/paramcontmodasiento_cp2#cuentascontables).
...
El sistema habilita los tipos contables según el tipo de comprobante seleccionado y propone el modelo de asiento para el comprobante:
  ...
  * [Detalle del modelo](https://ayudas.axoft.com/24ar/paramcontmodasiento_cp2#detalle_modelo)
  * [Detalle de apropiaciones](https://ayudas.axoft.com/24ar/paramcontmodasiento_cp2#detalle_apropiaciones)
