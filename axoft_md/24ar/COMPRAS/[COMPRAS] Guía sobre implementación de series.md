...
- Modulo: Compras
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_cp/guia_comprobdifer_cp/?p=17149/
...
Como primera medida, es necesario definir algunos [Parámetros de Stock](https://ayudas.axoft.com/24ar/parametrogeneral_st). Luego se deben ingresar los valores de series correspondientes a los artículos.
...
Ingrese al [Parámetros de Stock](https://ayudas.axoft.com/24ar/parametrogeneral_st) y configure los siguientes campos:
...
Para impedir el reingreso de series durante el ingreso de comprobantes de stock, consulte el proceso [Actualización de tipos de comprobante](https://ayudas.axoft.com/24ar/tipocomprobante_st).  
...
Una vez ingresados los [Parámetros de Stock](https://ayudas.axoft.com/24ar/parametrogeneral_st), indique en el proceso [Artículos](https://ayudas.axoft.com/24ar/articulo_carp_st), los artículos a identificar con números de serie, activando el parámetro [Lleva Series](https://ayudas.axoft.com/24ar/articulo_carp_st#series).
...
El ingreso de los números de serie sólo es obligatorio cuando esté activo el [Parámetro general](https://ayudas.axoft.com/24ar/parametrogeneral_st) Ingreso de Series Obligatorio.
...
[Ajustes de Inventario](https://ayudas.axoft.com/24ar/ajusteinventario_st) | Stock  
...
Según lo indicado en el [Tipo de Comprobante](https://ayudas.axoft.com/24ar/tipocomprobante_st), se verificará que la serie no haya tenido movimientos registrados y en caso de tenerlos, se impedirá su reingreso.  
Según lo indicado en [Parámetros de Stock](https://ayudas.axoft.com/24ar/parametrogeneral_st), se ingresarán los datos adicionales al número de serie.  
...
Si se activó el parámetro Valida Series Egreso del proceso [Parámetros de Stock](https://ayudas.axoft.com/24ar/parametrogeneral_st), el sistema validará que los números de serie indicados existan en el sistema como series activos. Si no se activó el parámetro, podrá indicar cualquier dato como número de serie.  
...
En el caso del proceso [Armado](https://ayudas.axoft.com/24ar/procesoarmado_st) varía la operatoria para el ingreso de números de serie. Para más información, consulte el [Proceso de armado](https://ayudas.axoft.com/24ar/procesoarmado_st).
...
Puede utilizar el proceso [Mantenimiento de números de serie por comprobante](https://ayudas.axoft.com/24ar/mantenseriecomprobante_st) si se desea completar los datos correspondientes al ingreso de series en el momento de la generación del comprobante. Al utilizar este proceso para ingresar los números de serie, se generará el número de serie activo y además se asociará el ingreso de la serie al comprobante de referencia.
...
En el caso de no ingresar los números de serie en el momento de registrar los comprobantes, los puede ingresar haciendo referencia al comprobante de ingreso por medio del proceso [Mantenimiento de Números de Serie por Comprobante](https://ayudas.axoft.com/24ar/mantenseriecomprobante_st).  
...
Puede consultar el informe de movimientos de series, ya sea por [artículo](?p=17183) o por [comprobante](https://ayudas.axoft.com/24ar/mantenseriecomprobante_st). Además, posee el informe Series activas, disponible desde el panel de Stock de Live.

##### Contenidos relacionados

  * [Mantenimiento de series](https://ayudas.axoft.com/24ar/ayudas/st/movimiento_carp_st/mantenimserie_st/)
