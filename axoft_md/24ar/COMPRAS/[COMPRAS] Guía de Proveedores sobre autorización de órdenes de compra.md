...
- Modulo: Compras
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_cp/guia_autorizoc_cp/
...
Para utilizar el circuito de autorización de órdenes de compra, siga los pasos detallados a continuación:
  ...
  * [Ítems de autorización para órdenes de compra](https://ayudas.axoft.com/24ar/autorizordencp_cp): usted puede definir varias instancias o "ítems" de autorización para un mismo comprobante, esto permite realizar diferentes controles sobre una misma orden de compra (realizados por diferentes personas, departamentos, etc.) (*).  
Si desea autorizar varios ítems por cada orden de compra, defina [ítems de autorización de órdenes de compra](https://ayudas.axoft.com/24ar/autorizordencp_cp).
  * [Parámetros de Proveedores](https://ayudas.axoft.com/24ar/paramgrales_cp): habilite la opción Utiliza el circuito de autorización dentro de la solapa Órdenes de compra de [Comprobantes](https://ayudas.axoft.com/24ar/paramgrales_cp/#parametros-para-comprobantes).  
...
Los ítems correspondientes a 'Generales' son aquellos asociados a información del encabezado de una orden de compra. La columna "Generales" dentro del área de acciones en el proceso de [Autorización de órdenes de compra](https://ayudas.axoft.com/24ar/autorizacion_cp) permite autorizar estos ítems.  
...
La columna "Renglones" dentro del área de acciones en el proceso de [Autorización de órdenes de compra](https://ayudas.axoft.com/24ar/autorizacion_cp) permite autorizar estos ítems.  
