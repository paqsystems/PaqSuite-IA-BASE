...
- Modulo: Compras
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_cp/guia_integrcontabl_cp/?p=27201/
...
El sistema completa esta pantalla tomando los datos del [modelo de asiento](?p=19368), o tomando los datos de [artículos](https://ayudas.axoft.com/24ar/articulo_carp_st) y [clientes](?p=19444).
...
El sistema completa esta pantalla:
  ...
  1. Toma las apropiaciones de [artículos](https://ayudas.axoft.com/24ar/articulo_carp_st) o [clientes](?p=19444).
