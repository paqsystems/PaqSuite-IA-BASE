...
- Modulo: Compras
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_cp/guia_integrcontabl_cp/?p=13179/
...
Mediante este proceso, se asigna a cada concepto definido en el proceso [Conceptos de liquidación](?p=13165/#conceptos-y-totales-liquidados), los siguientes datos para la confección del asiento:
...
Código de tipo de asiento: seleccione un [tipo de asiento](?p=11994) para asociar al modelo y poder agrupar la información para su análisis.

Actualizar conceptos: incorpora al detalle de conceptos de liquidación, aquellos registros incluidos en el proceso [Cuentas por defecto para modelos de asientos](?p=33767).

Actualizar conceptos de tipo aportes: incorpora al detalle de conceptos de aportes, aquellos registros incluidos en el proceso [Cuentas por defecto para modelos de asientos](?p=33767).
