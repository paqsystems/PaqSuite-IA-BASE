...
- Modulo: Compras
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_cp/guia_comprobdifer_cp/
...
Desvío: a medida que usted se desplace por los renglones de la lista de precios, si está activo el parámetro Verifica Desvío de Precios (en el proceso [Parámetros de Proveedores](https://ayudas.axoft.com/24ar/paramgrales_cp)) y el artículo tiene activado el parámetro Usa Desvío en Precios (en el proceso Artículos del módulo Stock), accede a la ventana de Desvío de Precios para su configuración. Defina el tipo de desvío a aplicar: 'Por Porcentaje' o bien, 'Por Precio' e ingrese el valor correspondiente (porcentaje o importe).
...
Durante el ingreso de comprobantes, si está activo el parámetro general Controla comprobantes con diferencias (del proceso [Parámetros de Proveedores](https://ayudas.axoft.com/24ar/paramgrales_cp/#parametros-para-controles)), se efectúa dicho control cuando en la factura se modifique el precio de los artículos.
