...
- Modulo: General
- Categoria: Operación
- URL: https://ayudas.axoft.com/24ar/documentos/operacion/tablas_oper/tablasresto_oper/
...
TRA126| Parámetros de control de artículos para cuentas de caja  
TRA127| Artículos con control para cuentas de caja  
...
TRA_FACTURA_TERMINAL| Relación de las facturas impresas desde la terminal remota  
...
TRA_RELACION_RENDICION| Relación rendición Tesorería Administración  
...
TRA_RESTODELIVERY_PARAMETER| Valores de configuración para servicio Restó Delivery  
TRA_ORDER_DELIVERY| Detalle de las órdenes de los pedidos del servicio Restó Delivery  
