...
- Modulo: General
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gla/guia_formgrafico_gla/?p=19178/
...
Será posible visualizar y seleccionar los artículos de cada cliente, cuando ejecute los procesos de [Facturación](https://ayudas.axoft.com/24ar/facturas_gv), [Pedidos](https://ayudas.axoft.com/24ar/ingresopedido_gv), [Cotización](https://ayudas.axoft.com/24ar/procesofacturacion_gv), [Notas de crédito](https://ayudas.axoft.com/24ar/emisionc_gv) y [Notas de débito](https://ayudas.axoft.com/24ar/emisionnd_gv) y active la modalidad 'Artículos / Cliente' con las teclas de función <Alt + F10>.  
...
Si está activo el [Parámetro general](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes) Permite alta de clientes desde procesos, usted puede agregar un nuevo cliente, pulsando la tecla <F6> desde el campo Código de cliente. En ese momento, se abrirá una pantalla igual a la del proceso [Clientes,](https://ayudas.axoft.com/24ar/clientes_carp_gv) para ingresar todos los datos correspondientes. Una vez finalizada la carga, pulse <F10> para confirmar el alta del artículo.
