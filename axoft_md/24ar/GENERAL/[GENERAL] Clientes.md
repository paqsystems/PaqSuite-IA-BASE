...
- Modulo: General
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gla/guia_guiagenerarchpdf_gla/?p=19444/
...
Para simplificar el ingreso de datos comunes a varios clientes, puede utilizar [plantillas](https://ayudas.axoft.com/24ar/valordefectoclientes_gv). Por ejemplo, puede definir una plantilla denominada "Clientes habituales" con los siguientes datos por defecto:
...
Si necesita actualizar un determinado campo a un grupo de clientes utilice el proceso [Actualización masiva de clientes](https://ayudas.axoft.com/24ar/actualizacionmasivacliente_gv). Por ejemplo, de esta forma puede asignar un grupo de clientes a una clasificación determinada para informes y estadísticas o indicar una nueva configuración impositiva a otro grupo.
...
Código de cliente: identifica en forma unívoca al cliente a ingresar. Estos códigos pueden agruparse desde la solapa Clientes de [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes).  
Está compuesto por: código de familia, código de grupo y código de individuo.  
Los nombres de los códigos de familia y los códigos de grupo se definen desde la solapa Clientes de [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes).
...
Si usted elige esta modalidad, al ingresar un nuevo cliente, se genera automáticamente el código a asignar (de acuerdo a lo ingresado en el proceso [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes) en el campo Próximo Código de cliente).
...
En el proceso [Longitud de Agrupaciones](https://ayudas.axoft.com/24ar/longagrupacion_gv) se define lo siguiente:
...
En el proceso [Agrupaciones de Clientes](https://ayudas.axoft.com/24ar/agrupacioncliente_gv) se define:
...
Finalmente, en el proceso [Clientes](https://ayudas.axoft.com/24ar/clientes_carp_gv) ingresamos:
...
Fecha de inhabilitación: esta fecha sirve como referencia del día de la inhabilitación del cliente. Si la fecha está en blanco significa que el cliente está habilitado. El tratamiento en el sistema de los clientes inhabilitados dependerá de lo configurado en el proceso [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv) para cada uno de los parámetros del ítem Clientes Inhabilitados.
...
Vencimiento y N° de certificado: con relación a lo establecido por la RG 1817 y si está activo el [parámetro general](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-controles) Controla vigencia certificado según RG 1817, ingrese la fecha de vencimiento y el número de certificado presentado por el cliente.  
...
El sistema controla los importes en los procesos de ingreso de comprobantes y si se excede el crédito disponible, emite un mensaje o bien no permite el ingreso, según la parametrización del perfil. Para más información, consulte el proceso [Perfiles de facturación](https://ayudas.axoft.com/24ar/perfilfacturacion_gv).
...
Este dato es de ingreso obligatorio si existen [configuraciones para cobranzas masivas](https://ayudas.axoft.com/24ar/configcobranzamasiva_gv) para las entidades recaudadoras (Pagomiscuentas, Pago Fácil o Rapipago).  
...
En el caso de haber generado facturas sin política asociada, posteriormente puede asignarles una política y comenzar a generar mora sobre los comprobantes que así lo requieran, utilizando el proceso [Gestión de débitos por mora](https://ayudas.axoft.com/24ar/gestiondebitomora_gv).  
...
Código de política de cálculo de interés por mora: indique la política de cálculo de interés por mora que debe aplicarse sobre los comprobantes del cliente. Este campo no es obligatorio. En el caso de no haber asignado un valor, se considera la política asignada a la [condición de ventas](https://ayudas.axoft.com/24ar/condicionventa_gv) o la asignada a nivel general en [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes).  
...
Dependiendo de lo configurado en los [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-comprobantes), en el ingreso de comprobantes podrá seleccionar una de las direcciones de entrega cargadas, para que el sistema realice el cálculo de impuestos correspondiente, teniendo en cuenta la configuración impositiva de la dirección seleccionada.
...
Según talonario: toma la configuración definida en el [talonario](https://ayudas.axoft.com/24ar/talonario_gv).
...
Por defecto, el sistema considera el idioma definido en la solapa Comprobantes electrónicos del proceso [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes).

Detalle de los artículos: defina si tiene en cuenta la descripción de los artículos ingresada en cada 'Artículo' o bien, la definida en la relación 'Cliente - Artículo'. Por defecto, el sistema considera lo definido en el proceso [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes).

Incluye comentarios de los artículos: indique si en la descripción del producto a informar a la AFIP incluye los comentarios ingresados para cada artículo desde el proceso [Artículos](https://ayudas.axoft.com/24ar/articulo_carp_st) del módulo Stock. Por defecto, el sistema considera lo definido en el proceso [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes).

Importante:

Recuerde que para operar con comprobantes electrónicos, parametrice correctamente los campos respectivos en la solapa Comprobantes electrónicos de [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-clientes).
...
##### Contenidos relacionados
  ...
  * [Video sobre Ley 27618 de monotributo](https://ayudas.axoft.com/24ar/videos/gral_carp_vid/leymonotributo_gral_vid/)
  ...
  * [Video sobre direcciones de entrega](https://ayudas.axoft.com/24ar/videos/gv_carp_vid/direntrega_gv_vid/)
