...
- Modulo: General
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gla/guia_guiastockentresuc_gla/?p=11987/
...
Para definir el criterio a utilizar ingrese a [Parámetros de transferencias](?p=11966).  
Si utiliza el circuito de transferencia manual, el asistente de exportación lo guiará en el paso a paso. Para más información sobre el asistente de exportación, consulte el tópico [Asistente para Transferencias](?p=11966/#asistente-para-transferencias).  
