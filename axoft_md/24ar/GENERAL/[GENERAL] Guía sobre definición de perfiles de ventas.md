...
- Modulo: General
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gla/guia_rg3685_gla/?p=27001/
...
Al definir un perfil de usuario, es posible configurar los permisos sobre cualquiera de las siguientes operaciones:
  ...
  * [Facturación](?p=19415)
  * [Emisión de notas de crédito](https://ayudas.axoft.com/24ar/emisionc_gv)
  * [Cierre de caja](https://ayudas.axoft.com/24ar/perfilcierrecajapos_gv)
  * [Remitos](https://ayudas.axoft.com/24ar/remito_carp_gv)
  * [Cotizaciones](https://ayudas.axoft.com/24ar/cotizacionperfconsintcli_gv)
  * [Aprobación](https://ayudas.axoft.com/24ar/perfilaprobac_gv)
  * [Consulta integral de clientes](https://ayudas.axoft.com/24ar/perfconsintegrcliente_gv)
  * [Consulta de precios y saldos de stock](https://ayudas.axoft.com/24ar/perfconsprecstock_gv)



Antes de comenzar con la implementación, le recomendamos tener en cuenta las siguientes consideraciones previas:

  * Por defecto, la definición de perfiles no es obligatoria. Si un usuario no tiene asignado ningún perfil, entonces estarán disponibles todas las funciones y se podrán ingresar todos los datos que prevé el sistema (algunos de estos valores surgen de [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-controles), [Clientes](https://ayudas.axoft.com/24ar/clientes_carp_gv) o [Talonarios](https://ayudas.axoft.com/24ar/talonario_gv)).  
Recuerde que, de ser necesario, puede configurar que la asignación de perfiles sea obligatoria en la sección Parámetros para controles de los [Parámetros de Ventas](https://ayudas.axoft.com/24ar/paramgrales_gv/#parametros-para-controles). De esta manera, si un usuario no tiene un perfil asignado no podrá ingresar al proceso solicitado.
...
1) Desde Archivos | Carga Inicial | Perfiles elija una de las opciones:
  ...
  * [Perfiles de pedidos](?p=10286). 
    * Defina [permisos eventuales](https://ayudas.axoft.com/24ar/claveautorizacion_gv) para aplicar claves de autorización temporaria mientras ingresa pedidos.
  * [Perfiles de facturación](https://ayudas.axoft.com/24ar/perfilfacturacion_gv). 
    * Definir [permisos eventuales](https://ayudas.axoft.com/24ar/claveautorizacion_gv) para aplicar claves de autorización temporaria mientras factura.
  * [Perfiles de medios de pago para facturas y pedidos](?p=19175).
  * [Perfiles de notas de crédito](https://ayudas.axoft.com/24ar/perfilnotacredito_gv). 
    * Definir [permisos eventuales](https://ayudas.axoft.com/24ar/claveautorizacion_gv) para aplicar claves de autorización temporaria mientras ingresa comprobantes de crédito.
  * [Perfiles de cierre de caja](https://ayudas.axoft.com/24ar/perfilcierrecajapos_gv).
  * [Perfiles de remitos](https://ayudas.axoft.com/24ar/perfilremito_gv). 
    * Definir [permisos eventuales](https://ayudas.axoft.com/24ar/claveautorizacion_gv) para aplicar claves de autorización temporaria mientras remite.
  * [Perfiles de consulta integral de clientes](https://ayudas.axoft.com/24ar/itemgralperfconsintcli_gv).
  * [Perfiles de aprobación](https://ayudas.axoft.com/24ar/perfilaprobac_gv).
  * [Perfiles de consulta de precios y saldos de stock](https://ayudas.axoft.com/24ar/perfconsprecstock_gv).
...
Además, usted puede definir [permisos eventuales](https://ayudas.axoft.com/24ar/claveautorizacion_gv) para indicar las acciones qué sólo pueden ser realizadas mediante el ingreso de una contraseña (clave de autorización temporal) por parte de un usuario autorizado (por ejemplo el ingreso de [perfiles de aprobación](https://ayudas.axoft.com/24ar/perfilaprobac_gv) con descuento o la generación de notas de crédito a partir de un importe determinado).  
...
Para conocer más sobre las acciones que pueden requerir autorización (comportamiento autoriza o autoriza fuera de límite), consulte [Aplicar permisos eventuales](https://ayudas.axoft.com/24ar/claveautorizacion_gv).
...
##### Contenidos relacionados
  ...
  * [Facturación masiva de pedidos de Tango Tiendas](https://ayudas.axoft.com/24ar/ayudas/gv/procesofacturacion_gv/pos_gv/factmas_carp_posgv/factmaspedtienda_posgv/)
