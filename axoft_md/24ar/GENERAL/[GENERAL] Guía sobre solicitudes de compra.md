...
- Modulo: General
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_gla/guia_rg3572_gla/?p=14476/
...
Para más información consulte [Parámetros de Compras](https://ayudas.axoft.com/24ar/paramgrales_cp2).
...
Para más información, consulte [Talonarios](https://ayudas.axoft.com/24ar/talonario_cp2).
  3. Artículos Genéricos (opcional) (*): defina un conjunto de artículos que podrá ser utilizado en el ingreso de solicitud de compra. Utilice este tipo de artículos en el Ingreso de Solicitud de Compra para indicar al comprador que puede reemplazar el artículo a comprar (nombrado en forma genérica) por otros similares. Para más información vea el siguiente ejemplo o consulte el tópico [Artículos genéricos](https://ayudas.axoft.com/24ar/articulogenerico_cp2).
  4. Motivos (opcional): defina los motivos que utilizará en el momento de cerrar o desautorizar una solicitud de compra.  
Para más información, consulte [Motivos](https://ayudas.axoft.com/24ar/motivos_cp2).
...
Para más información, consulte [Clasificación 1](https://ayudas.axoft.com/24ar/clasificacion1_cp2) y [Clasificación 2](https://ayudas.axoft.com/24ar/clasificacion2_cp2).
...
Para más información, consulte [Textos para comprobantes de compra](https://ayudas.axoft.com/24ar/textocomprobcp_cp2).
...
Para más información, consulte [Perfiles de solicitud de compra](https://ayudas.axoft.com/24ar/perfsolicitudcp_cp2).
...
Para más información, consulte [Actualización de solicitudes de compra](https://ayudas.axoft.com/24ar/solicpactualiz_cp2).
...
Para más información, consulte [Autorización de solicitudes de compra](https://ayudas.axoft.com/24ar/solicpautoriz_cp2).
...
Para más información, consulte la ayuda de [Gestión de solicitudes de compra](https://ayudas.axoft.com/24ar/solicpgestion_cp2).
...
Para más información, consulte la ayuda de [Generación de órdenes de compra](https://ayudas.axoft.com/24ar/ordencpgeneracion_cp2).
...
Operaciones tales como [devolución de remitos](https://ayudas.axoft.com/24ar/remdevolucion_cp2), [anulación de remitos](https://ayudas.axoft.com/24ar/remanulacion_cp2), [cierre de orden de compra](https://ayudas.axoft.com/24ar/ordencpgeneracion_cp2), [anulación de orden de compra](https://ayudas.axoft.com/24ar/ordencpgeneracion_cp2) y [baja de comprobantes](https://ayudas.axoft.com/24ar/comprobaja_cp2), pueden afectar los saldos pendientes de sus solicitudes de compra. Para mayor detalle sobre cambios de estado y administración de saldos pendientes, consulte la ayuda de cada uno de estos procesos en particular.
...
Desde el proceso de [Solicitudes de compra](https://ayudas.axoft.com/24ar/solicp_cp2), obtenga información sobre:
  ...
  * **Estados de las solicitudes y saldos pendientes:** aplique filtros según los datos que precise ver en cada momento (sucursal, sector, fechas de ingreso, fecha de autorización, clasificaciones, etc.). Dependiendo los datos que precise ver, puede acceder a esta información desde: 
    * [Actualización de solicitudes](https://ayudas.axoft.com/24ar/solicpactualiz_cp2).
    * [Gestión de solicitudes](https://ayudas.axoft.com/24ar/solicpgestion_cp2).
    * [Autorización de solicitudes](https://ayudas.axoft.com/24ar/solicpautoriz_cp2).
  * **Historial de movimientos detallado por artículo:** consulte la "trazabilidad" de un artículo, visualizando información de todos los comprobantes relacionados con éste, mediante la [Actualización de solicitudes](https://ayudas.axoft.com/24ar/solicpactualiz_cp2).
