...
- Modulo: General
- Categoria: Guía
- URL: https://ayudas.axoft.com/24ar/documentos/guias/guias_carp_iv/guia_integrcontabl_guia_iva/?p=8424/
...
Al activarlo, se generarán los asientos contables una vez que los comprobantes que generan asiento sean ingresados. En caso de desactivarlo se deberá generar el asiento desde el proceso [Generación de asientos contables](?p=8390) de Liquidador de IVA.
