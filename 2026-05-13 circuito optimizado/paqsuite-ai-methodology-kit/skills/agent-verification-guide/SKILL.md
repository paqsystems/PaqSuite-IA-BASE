...
description: verify implementation evidence before claiming completion. use after a tr or code change is implemented and before closure or pr. checks scope, code, db, backend, frontend, tests, docs, traceability, missing evidence, and produces approved, approved with observations, or not approved verdicts.
---

# Guia de Verificacion Agente
